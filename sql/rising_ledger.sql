...
DROP FUNCTION IF EXISTS public.rising_ledger(integer, integer);
...
GRANT EXECUTE ON FUNCTION public.rising_ledger(integer, integer, text[]) TO anon, authenticated, service_role;
