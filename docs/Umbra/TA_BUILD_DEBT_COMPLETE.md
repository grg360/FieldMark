...
### from TA_BUILD_DEBT.md
- [1. POST-MORTEM — how the AD corpus got contaminated (the cautionary tale)](#1-post-mortem-how-the-ad-corpus-got-contaminated-the-cautionary-tale)
- [2. PARAMETERIZATION debt (blocks automation blocker #1)](#2-parameterization-debt-blocks-automation-blocker-1)
- [3. RESUMABILITY / IDEMPOTENCY debt (blocks automation blocker #2)](#3-resumability-idempotency-debt-blocks-automation-blocker-2)
- [4. VERIFICATION-GATES-AS-CODE debt (blocks automation blocker #3)](#4-verification-gates-as-code-debt-blocks-automation-blocker-3)
- [5. AD-SPECIFIC config debt (must clear before later pipeline stages)](#5-ad-specific-config-debt-must-clear-before-later-pipeline-stages)
- [6. The shared-inventory extension problem (RESOLVED — see Playbook §0b)](#6-the-shared-inventory-extension-problem-resolved-see-playbook-0b)
- [7. Specific bugs / anti-patterns / infra notes](#7-specific-bugs-anti-patterns-infra-notes)
- [8. Deletion records this session (for audit / rollback)](#8-deletion-records-this-session-for-audit-rollback)
- [9. Tagging-layer enhancements (surfaced during AD concept curation, July 3)](#9-tagging-layer-enhancements-surfaced-during-ad-concept-curation-july-3)
- [10. Enrichment ontology / mechanism allowlist (unbuilt)](#10-enrichment-ontology-mechanism-allowlist-unbuilt)
- [11. AD concept-tagging validation (after first tagging run)](#11-ad-concept-tagging-validation-after-first-tagging-run)
- [12. REAL SCORING ARCHITECTURE (established this morning — supersedes prior confusion)](#12-real-scoring-architecture-established-this-morning-supersedes-prior-confusion)
- [13. FULL AD SCORING PIPELINE (5 stages, AD has completed ~0)](#13-full-ad-scoring-pipeline-5-stages-ad-has-completed-0)
- [14. OPEN METHODOLOGY DECISION — how to treat legitimately-missing pharma  [NEEDS DELIBERATE DECISION]](#14-open-methodology-decision-how-to-treat-legitimately-missing-pharma-needs-deliberate-decision)
- [15. INDUSTRY/NIH HCP TREATMENT (reconstructed from NSCLC data, was undocumented)](#15-industrynih-hcp-treatment-reconstructed-from-nsclc-data-was-undocumented)
- [16. STATE-DERIVATION STEP MISSING FOR AD (blocks NPPES matching quality)](#16-state-derivation-step-missing-for-ad-blocks-nppes-matching-quality)
- [17. NPPES SCRIPT RETROFIT (done this morning, ready pending state-derivation)](#17-nppes-script-retrofit-done-this-morning-ready-pending-state-derivation)
- [18. INSTITUTION_MASTER reference table (ADVISOR-PROPOSED — designed, DEFERRED, high-leverage)](#18-institution_master-reference-table-advisor-proposed-designed-deferred-high-leverage)
- [19. NPPES LEG COMPLETE (AD)](#19-nppes-leg-complete-ad)
- [20. OPEN PAYMENTS GATE — fully scoped, NOT yet run. 3 prerequisites.](#20-open-payments-gate-fully-scoped-not-yet-run-3-prerequisites)
- [21. DEFERRED — Advisor's drug-dimension redesign (good, build deliberately later, like institution_master)](#21-deferred-advisors-drug-dimension-redesign-good-build-deliberately-later-like-institution_master)
- [19b. NPPES write — VERIFIED with 2 minor discrepancies to reconcile next session](#19b-nppes-write-verified-with-2-minor-discrepancies-to-reconcile-next-session)
- [21b. ta_drug_keywords AD — INSERTED (12 drugs), advisor-approved with 2 refinements](#21b-ta_drug_keywords-ad-inserted-12-drugs-advisor-approved-with-2-refinements)
- [21c. AD drug list — refined via unmatched diagnostic (now 14 drugs)](#21c-ad-drug-list-refined-via-unmatched-diagnostic-now-14-drugs)
- [21d. drug_status field — advisor recommended TWICE (prioritize in §21 redesign)](#21d-drug_status-field-advisor-recommended-twice-prioritize-in-21-redesign)
- [21e. REUSABLE PLAYBOOK STEP surfaced: drug-list refinement loop](#21e-reusable-playbook-step-surfaced-drug-list-refinement-loop)
- [21f. Aggregator log-line cleanup (agent-safety, minor) + 49298 reconciled](#21f-aggregator-log-line-cleanup-agent-safety-minor-49298-reconciled)
- [14b. §14 REFRAME (user insight) — pharma-0 may be a COHORT question, not just a scoring one](#14b-14-reframe-user-insight-pharma-0-may-be-a-cohort-question-not-just-a-scoring-one)
- [22. Pharma scoring — WORKS; breadth-vs-dollars weighting is a review item (not a blocker)](#22-pharma-scoring-works-breadth-vs-dollars-weighting-is-a-review-item-not-a-blocker)
- [22b. Pharma breadth weighting — RATIONALE (user), reclassify from "review item" to "deliberate/correct"](#22b-pharma-breadth-weighting-rationale-user-reclassify-from-review-item-to-deliberatecorrect)
- [23. FOUNDATIONAL GAP FOUND — Established/Rising Star cohort classifiers DO NOT EXIST as scripts](#23-foundational-gap-found-establishedrising-star-cohort-classifiers-do-not-exist-as-scripts)
- [23b. RESOLVED diagnosis — Established/Rising classifier was NEVER scripted (ad-hoc), but RECONSTRUCTIBLE](#23b-resolved-diagnosis-establishedrising-classifier-was-never-scripted-ad-hoc-but-reconstructible)
- [23c. THRESHOLD RECOVERED — Established = cohort_score >= 85; split is 2-DIMENSIONAL](#23c-threshold-recovered-established-cohort_score-85-split-is-2-dimensional)
- [23d. cohort_score writer ALSO not in committed code; recovering from prior chat history](#23d-cohort_score-writer-also-not-in-committed-code-recovering-from-prior-chat-history)
- [23e. RECOVERED (from "Working with Cursor Pt.12", May 29 2026) — full cohort classification methodology](#23e-recovered-from-working-with-cursor-pt12-may-29-2026-full-cohort-classification-methodology)
- [23f. TWO COMPLICATIONS to resolve BEFORE running the recovered SQL (do NOT run as-is)](#23f-two-complications-to-resolve-before-running-the-recovered-sql-do-not-run-as-is)
- [14c. §14 RESOLVED (from Cursor Pt.19, July 3) — recompute REWEIGHTS, does NOT penalize missing pharma](#14c-14-resolved-from-cursor-pt19-july-3-recompute-reweights-does-not-penalize-missing-pharma)
- [12b. TWO scoring systems coexist (from Cursor Pt.19) — resolves the trials question partially](#12b-two-scoring-systems-coexist-from-cursor-pt19-resolves-the-trials-question-partially)
- [23g. TRIALS QUESTION RESOLVED (from chat recovery) — NO CONFLICT; scoring_pipeline.py correct as-is](#23g-trials-question-resolved-from-chat-recovery-no-conflict-scoring_pipelinepy-correct-as-is)
- [24. THIRD MISSING ENRICHMENT LEG FOUND — AD trials are UNDER-INGESTED (blocks correct classification)](#24-third-missing-enrichment-leg-found-ad-trials-are-under-ingested-blocks-correct-classification)
- [25. INCIDENT (July 6) — trials_pipeline.py write bug DEGRADED matched trial links across ALL TAs](#25-incident-july-6-trials_pipelinepy-write-bug-degraded-matched-trial-links-across-all-tas)
- [25b. FIX CONFIRMED WORKING (July 6, same session) — RPC preserves matches; restore underway](#25b-fix-confirmed-working-july-6-same-session-rpc-preserves-matches-restore-underway)
- [25c. NSCLC RESTORE COMPLETE — incident closed for NSCLC](#25c-nsclc-restore-complete-incident-closed-for-nsclc)
- [26. MAJOR FINDING — AD HCP membership is ~28% CROSS-CONTAMINATED (blocks scoring)](#26-major-finding-ad-hcp-membership-is-28-cross-contaminated-blocks-scoring)
- [25d. AD trials run INTERRUPTED at 466/15,902 (resume later, AFTER membership fix)](#25d-ad-trials-run-interrupted-at-46615902-resume-later-after-membership-fix)
- [26b. CORRECTION to §26 — NOT contamination. Membership is SOUND. Cross-TA HCPs are legitimate.](#26b-correction-to-26-not-contamination-membership-is-sound-cross-ta-hcps-are-legitimate)
- [25e. WHY AD TRIALS ONLY DID 466 — get_hcps requires non-null nppes_practice_state (US-first filter)](#25e-why-ad-trials-only-did-466-get_hcps-requires-non-null-nppes_practice_state-us-first-filter)
- [25f. AD trials leg LARGELY SUCCEEDED but has a KOL RECALL GAP (Silverberg=0)](#25f-ad-trials-leg-largely-succeeded-but-has-a-kol-recall-gap-silverberg0)
- [25g. ROOT CAUSE of Silverberg=0 — CT.gov query.term is FULL-TEXT, swamps common/collision names](#25g-root-cause-of-silverberg0-ctgov-queryterm-is-full-text-swamps-commoncollision-names)
- [25h. Silverberg gap is a CT.gov DATA CEILING, not a search bug — NOT fixable by better queries](#25h-silverberg-gap-is-a-ctgov-data-ceiling-not-a-search-bug-not-fixable-by-better-queries)
- [27. COHORT CLASSIFICATION REBUILD — Option A (dedicated per-TA table). DECISIONS LOCKED.](#27-cohort-classification-rebuild-option-a-dedicated-per-ta-table-decisions-locked)
- [27b. PREREQUISITE for classification — AD career data (career_first_pub_year_v2 + corrected total_career_pubs) is INCOMPLETE](#27b-prerequisite-for-classification-ad-career-data-career_first_pub_year_v2-corrected-total_career_pubs-is-incomplete)
- [27c. career_enrichment_from_clusters.py RE-IMPORTS the conflation bug — do NOT run as-is for AD](#27c-career_enrichment_from_clusterspy-re-imports-the-conflation-bug-do-not-run-as-is-for-ad)
- [27d. NSCLC career_first_pub_year_v2 is POPULATED (92%) but still garbage-TAILED (min 1837) — guard needed](#27d-nsclc-career_first_pub_year_v2-is-populated-92-but-still-garbage-tailed-min-1837-guard-needed)
- [27e. CRITICAL nuance — join-table first_pub_year = "earliest INGESTED pub", NOT "career start"](#27e-critical-nuance-join-table-first_pub_year-earliest-ingested-pub-not-career-start)
- [27f. RESOLVED — NSCLC method confirmed empirically; my §27c/§27e caution was OVERCOMPLICATED](#27f-resolved-nsclc-method-confirmed-empirically-my-27c27e-caution-was-overcomplicated)
- [27g. RESOLVED excavation + REAL prerequisite found — AD author metrics only 26% populated](#27g-resolved-excavation-real-prerequisite-found-ad-author-metrics-only-26-populated)
- [27h. DONE — AD career_first_pub_year_v2 populated via sustained-onset method. Silverberg=2008.](#27h-done-ad-career_first_pub_year_v2-populated-via-sustained-onset-method-silverberg2008)
- [27h-verify. AD career-year distribution CONFIRMED sane (parity with NSCLC)](#27h-verify-ad-career-year-distribution-confirmed-sane-parity-with-nsclc)
- [27i. DONE — AD total_career_pubs de-inflated (join-table COUNT). Silverberg 1223->465.](#27i-done-ad-total_career_pubs-de-inflated-join-table-count-silverberg-1223-465)
- [28. FUTURE-PROOFING TODO — scope the LOADS in scoring_pipeline.py --ta, not just the compute](#28-future-proofing-todo-scope-the-loads-in-scoring_pipelinepy---ta-not-just-the-compute)
- [28b. Pagination guard bug found + scope-the-loads promoted to REQUIRED (option B)](#28b-pagination-guard-bug-found-scope-the-loads-promoted-to-required-option-b)
- [28c. AD scoring dry-run SUCCESS — load-scoping + career-data both validated](#28c-ad-scoring-dry-run-success-load-scoping-career-data-both-validated)
- [28d. ORDER RESOLVED — CLASSIFY FIRST (career-based), then cohort-score. User was right.](#28d-order-resolved-classify-first-career-based-then-cohort-score-user-was-right)
- [28e. CONFIRMED cohort-gate logic (the exact rules the §27 classifier must apply)](#28e-confirmed-cohort-gate-logic-the-exact-rules-the-27-classifier-must-apply)
- [28f. §27 CLASSIFIER BUILT + AD DRY-RUN VALIDATED. Silverberg -> established.](#28f-27-classifier-built-ad-dry-run-validated-silverberg---established)
- [28g. DRY-RUN CAUGHT A REAL ISSUE — global total_career_pubs pollutes per-TA established ranking](#28g-dry-run-caught-a-real-issue-global-total_career_pubs-pollutes-per-ta-established-ranking)
- [28h. RESOLVED (28g) — established SCORER is TA-scoped; global-count classification is harmless. Execute OK.](#28h-resolved-28g-established-scorer-is-ta-scoped-global-count-classification-is-harmless-execute-ok)
- [28i. CONFIRMED BUG (28g escalated) — establishment uses GLOBAL pub count; 73% of AD "established" are passengers](#28i-confirmed-bug-28g-escalated-establishment-uses-global-pub-count-73-of-ad-established-are-passengers)
- [28j. AD-specific pub count: great discriminator for passengers, BUT under-counts some real KOLs](#28j-ad-specific-pub-count-great-discriminator-for-passengers-but-under-counts-some-real-kols)
- [28k. REAL ROOT CAUSE — AD publication corpus is severely UNDER-INGESTED (not a classifier bug)](#28k-real-root-cause-ad-publication-corpus-is-severely-under-ingested-not-a-classifier-bug)
- [28l. REFRAME — not "under-ingested vs career total"; the career total ITSELF reflects the thin corpus](#28l-reframe-not-under-ingested-vs-career-total-the-career-total-itself-reflects-the-thin-corpus)
- [28m. ROOT CAUSE FOUND — author identity FRAGMENTATION via Unicode hyphen variants](#28m-root-cause-found-author-identity-fragmentation-via-unicode-hyphen-variants)
- [28n. Fragmentation SCALE + the two sub-problems (safe merges vs unsafe homonyms)](#28n-fragmentation-scale-the-two-sub-problems-safe-merges-vs-unsafe-homonyms)
- [28o. CRITICAL merge-design refinement — THREE patterns, must not conflate. Leung is the cautionary tale.](#28o-critical-merge-design-refinement-three-patterns-must-not-conflate-leung-is-the-cautionary-tale)
- [28p. Dedup subsystem EXISTS but doesn't fold Unicode/diacritics -> misses AD's fragmentation](#28p-dedup-subsystem-exists-but-doesnt-fold-unicodediacritics---misses-ads-fragmentation)
- [28q. Dedup detector logic is SOUND - fix is a surgical normalization injection (+ maybe --ta)](#28q-dedup-detector-logic-is-sound---fix-is-a-surgical-normalization-injection-maybe---ta)
- [28r. CRITICAL - merger's canonical selection uses total_career_pubs, which de-inflation INVERTED for fragments](#28r-critical---mergers-canonical-selection-uses-total_career_pubs-which-de-inflation-inverted-for-fragments)
- [28s. Detection caught only 17 candidates - MISSES the known AD KOL fragments (corroboration too strict)](#28s-detection-caught-only-17-candidates---misses-the-known-ad-kol-fragments-corroboration-too-strict)
- [28t. Real cause of "only 17" — likely a STUB-vs-PRIMARY pairing model, not fragment-vs-fragment](#28t-real-cause-of-only-17-likely-a-stub-vs-primary-pairing-model-not-fragment-vs-fragment)
- [28u. CONFIRMED - detector is stub-absorption only; structurally cannot catch fragment-vs-fragment](#28u-confirmed---detector-is-stub-absorption-only-structurally-cannot-catch-fragment-vs-fragment)
- [28v. Rarity threshold - CLEAN separation in the data. Fragment-pairing design finalized.](#28v-rarity-threshold---clean-separation-in-the-data-fragment-pairing-design-finalized)
- [28w. Fragment detection: KOLs CAUGHT correctly, but 111,711 needs_corroboration noise + 3,552 high-conf to vet](#28w-fragment-detection-kols-caught-correctly-but-111711-needs_corroboration-noise-3552-high-conf-to-vet)
- [28x. STOP - high-confidence fragment bucket is UNSAFE. Both safety mechanisms failed. DO NOT MERGE.](#28x-stop---high-confidence-fragment-bucket-is-unsafe-both-safety-mechanisms-failed-do-not-merge)
- [28y. RESOLVED via NSCLC precedent - common Asia-Pac names are LEFT SEPARATE, never merged. That's correct.](#28y-resolved-via-nsclc-precedent---common-asia-pac-names-are-left-separate-never-merged-thats-correct)
- [28z. COMMITTED RULE - the Asian/common-name cohort is NOT dedupable; do not try. (User's standing decision.)](#28z-committed-rule---the-asiancommon-name-cohort-is-not-dedupable-do-not-try-users-standing-decision)
- [28aa. Fragment path FIXED + re-vetted clean. Root cause was an indentation bug.](#28aa-fragment-path-fixed-re-vetted-clean-root-cause-was-an-indentation-bug)
- [28ab. Review of the 3,058 high-conf set - KOLs good, but common WESTERN names + transitive clusters need care](#28ab-review-of-the-3058-high-conf-set---kols-good-but-common-western-names-transitive-clusters-need-care)
- [28ac. ONTOLOGIST DOCTRINE ADOPTED - evidence-scoring identity resolution, not surname thresholds](#28ac-ontologist-doctrine-adopted---evidence-scoring-identity-resolution-not-surname-thresholds)
- [28ad. DECISION - Path B: implement the HIGH-CONFIDENCE BAND of the future resolver (strict subset, not throwaway)](#28ad-decision---path-b-implement-the-high-confidence-band-of-the-future-resolver-strict-subset-not-throwaway)
- [28ae. ADVISOR converges with ontologist + adds refinements. Reframe: AMBIGUITY not geography.](#28ae-advisor-converges-with-ontologist-adds-refinements-reframe-ambiguity-not-geography)
- [28af. Corroboration too weak - both_have_openalex + pub_domain_overlap are near-universal (false signals). Tighten.](#28af-corroboration-too-weak---both_have_openalex-pub_domain_overlap-are-near-universal-false-signals-tighten)
- [28ag. Fragment high-confidence band FINALIZED + clean. 631 corroborated merges. Osborn correctly demoted.](#28ag-fragment-high-confidence-band-finalized-clean-631-corroborated-merges-osborn-correctly-demoted)
- [28ah. Merge DRY-RUN validated - transitive components correct, KOLs resolve to rich survivor. Ready to execute.](#28ah-merge-dry-run-validated---transitive-components-correct-kols-resolve-to-rich-survivor-ready-to-execute)
- [28ai. Merge EXECUTED - ~590 succeeded, ~55 failed cleanly on missing FK (hcp_top_collaborators_v2). Recoverable.](#28ai-merge-executed---590-succeeded-55-failed-cleanly-on-missing-fk-hcp_top_collaborators_v2-recoverable)
- [28ai-update. Real merge numbers: 482 succeeded, 132 failed (not ~55). Clean state, overlap 0.](#28ai-update-real-merge-numbers-482-succeeded-132-failed-not-55-clean-state-overlap-0)
- [28aj. Guttman-Yassky merge CONFIRMED correct - identity consolidated, other Guttmans correctly untouched.](#28aj-guttman-yassky-merge-confirmed-correct---identity-consolidated-other-guttmans-correctly-untouched)
- [28ak. FK fix was 17 MISSING columns, not 1 - full audit prevented cascade of failures + silent score loss.](#28ak-fk-fix-was-17-missing-columns-not-1---full-audit-prevented-cascade-of-failures-silent-score-loss)
- [28al. FRAGMENT MERGE COMPLETE. Run 2: 104 more merged, 0 FK violations, overlap 0. Done.](#28al-fragment-merge-complete-run-2-104-more-merged-0-fk-violations-overlap-0-done)
- [29a. Merge landing CONFIRMED on both benchmarks. Identity vs corpus-linkage cleanly separated.](#29a-merge-landing-confirmed-on-both-benchmarks-identity-vs-corpus-linkage-cleanly-separated)
- [29b. total_career_pubs re-derived on merged identities (dedup-then-deinflate, correct order). ](#29b-total_career_pubs-re-derived-on-merged-identities-dedup-then-deinflate-correct-order-)
- [29c. career_first_pub_year_v2 re-derived on merged identities. Guttman-Yassky 2003 (from rich survivor).](#29c-career_first_pub_year_v2-re-derived-on-merged-identities-guttman-yassky-2003-from-rich-survivor)
- [29d. Classifier re-run on merged identities - classification CORRECT; preview pub-sort still cosmetic-hepatologist.](#29d-classifier-re-run-on-merged-identities---classification-correct-preview-pub-sort-still-cosmetic-hepatologist)
- [29e. DECISION - hepatologists should NOT appear in AD established at all (not just rank low). TA-anchor establishment.](#29e-decision---hepatologists-should-not-appear-in-ad-established-at-all-not-just-rank-low-ta-anchor-establishment)
- [29f. CRITICAL - is_senior_author / is_first_author are UNPOPULATED (all 0, even for Silverberg 464 AD pubs).](#29f-critical---is_senior_author-is_first_author-are-unpopulated-all-0-even-for-silverberg-464-ad-pubs)
- [29g. TA-anchored establishment WORKS. Hepatologists gone. Established 9,449 -> 2,547 (16.1%, credible KOL tier).](#29g-ta-anchored-establishment-works-hepatologists-gone-established-9449---2547-161-credible-kol-tier)
- [29h. Classifier dry-run verified by user's own eyes - edge cases all correct. Execute.](#29h-classifier-dry-run-verified-by-users-own-eyes---edge-cases-all-correct-execute)
- [29i. *** GENERALIZATION VERDICT: YES *** AD established cohort = a real AD who's-who. Hepatologists gone.](#29i-generalization-verdict-yes-ad-established-cohort-a-real-ad-whos-who-hepatologists-gone)
- [29j. hcp_cohort_classification_v2 needed GRANT (recurring new-table issue). Fixed.](#29j-hcp_cohort_classification_v2-needed-grant-recurring-new-table-issue-fixed)
- [29k. Cohort classification PERSISTED on merged/TA-anchored identities. AD cohorts DONE.](#29k-cohort-classification-persisted-on-mergedta-anchored-identities-ad-cohorts-done)
- [29l. author_position IS in the OpenAlex JSON -> scorer-ranking fix is a DERIVE (not re-enrich). Outcome #1.](#29l-author_position-is-in-the-openalex-json---scorer-ranking-fix-is-a-derive-not-re-enrich-outcome-1)
- [29m. Authorship-position DERIVED + populated. Signal ALIVE. Silverberg 198 senior/135 first.](#29m-authorship-position-derived-populated-signal-alive-silverberg-198-senior135-first)
- [29n. *** AD ESTABLISHED KOL RANKING PRODUCED *** Credible top-15. Scorer wired + authorship signal live.](#29n-ad-established-kol-ranking-produced-credible-top-15-scorer-wired-authorship-signal-live)
- [29o. Under-linkage is SYSTEMIC, not a tail - 864/2,547 established (34%) are big-career/thin-linkage KOLs.](#29o-under-linkage-is-systemic-not-a-tail---8642547-established-34-are-big-careerthin-linkage-kols)
- [29p. Missing-link gap quantified + DERIVABLE via SQL (not full Step F re-run). 17,315 missing, 7,273 HCPs.](#29p-missing-link-gap-quantified-derivable-via-sql-not-full-step-f-re-run-17315-missing-7273-hcps)
- [29q. *** CORPUS RE-LINK DONE *** Guttman-Yassky 6->297 links (126 senior). NSCLC provably untouched.](#29q-corpus-re-link-done-guttman-yassky-6-297-links-126-senior-nsclc-provably-untouched)
- [29r. *** LOOP CLOSED: TRUSTWORTHY AD KOL RANKING *** Guttman-Yassky #1732 -> #3. Full arc paid off.](#29r-loop-closed-trustworthy-ad-kol-ranking-guttman-yassky-1732---3-full-arc-paid-off)
- [29s. Script-hygiene note: publication_leadership_scoring.py DEFAULTS TO WRITING (--dry-run is opt-out).](#29s-script-hygiene-note-publication_leadership_scoringpy-defaults-to-writing---dry-run-is-opt-out)
- [29t. Network centrality scorer assessed - GOOD shape, benefits from re-link, likely no wiring fix needed.](#29t-network-centrality-scorer-assessed---good-shape-benefits-from-re-link-likely-no-wiring-fix-needed)
- [29u. Pharma scorer assessed - clean EXCEPT the debt #14 missing-pharma question (must verify).](#29u-pharma-scorer-assessed---clean-except-the-debt-14-missing-pharma-question-must-verify)
- [29v. Pharma table = scenario 1 (CORRECT). 275 rows, 0 zero-payment. Scorer ready as-is.](#29v-pharma-table-scenario-1-correct-275-rows-0-zero-payment-scorer-ready-as-is)
- [29w. Network centrality DONE. 19,926 rows. Credible AD hubs; re-link flows into graph correctly.](#29w-network-centrality-done-19926-rows-credible-ad-hubs-re-link-flows-into-graph-correctly)
- [29x. PAUSE - user concern: pharma covers only 275/2,547 established (11%). Two distinct problems.](#29x-pause---user-concern-pharma-covers-only-2752547-established-11-two-distinct-problems)
- [29y. RESOLVED - pharma sparsity is STRUCTURAL (scenario a), not a gap. AD is 73% international.](#29y-resolved---pharma-sparsity-is-structural-scenario-a-not-a-gap-ad-is-73-international)
- [29z. ADVISOR VERDICT - SEPARATE THE AXES. Remove commercial from KOL score entirely; profile not single score.](#29z-advisor-verdict---separate-the-axes-remove-commercial-from-kol-score-entirely-profile-not-single-score)
- [29aa. Trial-leadership data check - ROLE granularity EXISTS but MATCH RATE is the blocker (validates skepticism).](#29aa-trial-leadership-data-check---role-granularity-exists-but-match-rate-is-the-blocker-validates-skepticism)
- [29ab. VERDICT - trial leadership NOT usable now. Skepticism CONFIRMED. Fails on the KOLs that matter.](#29ab-verdict---trial-leadership-not-usable-now-skepticism-confirmed-fails-on-the-kols-that-matter)
- [29ac. ADVISOR round 2 - drop the ct.gov chase; IMPROVE the scientific score instead. Prestige signals are in PubMed.](#29ac-advisor-round-2---drop-the-ctgov-chase-improve-the-scientific-score-instead-prestige-signals-are-in-pubmed)
- [29ad. Composite ALREADY flexible + already reweights missing signals. Prestige metadata READY. Two wins.](#29ad-composite-already-flexible-already-reweights-missing-signals-prestige-metadata-ready-two-wins)
- [29ae. PRINCIPLE - scoring nimbleness lives at the DATA-AVAILABILITY layer, not the CONCEPT layer.](#29ae-principle---scoring-nimbleness-lives-at-the-data-availability-layer-not-the-concept-layer)
- [29af. Composite dry-run: WIRING correct (2,547) BUT network-skew visible in global ranking (advisor's caution real).](#29af-composite-dry-run-wiring-correct-2547-but-network-skew-visible-in-global-ranking-advisors-caution-real)
- [29ag. Scientific score is WELL-BUILT - guidelines already weighted highest. Two issues for advisor.](#29ag-scientific-score-is-well-built---guidelines-already-weighted-highest-two-issues-for-advisor)
- [29ah. ADVISOR - 75/25 sci/net, percentile display (not min-max), VALIDATE don't tune. Applied.](#29ah-advisor---7525-scinet-percentile-display-not-min-max-validate-dont-tune-applied)
- [29ai. *** VALIDATION PASSED at 75/25. Ship it. *** Global top recovers ALL reference KOLs.](#29ai-validation-passed-at-7525-ship-it-global-top-recovers-all-reference-kols)
- [29aj. ADVISOR - it's a CEILING problem not a weight problem. min-max saturated the sci axis. + a dupe bug.](#29aj-advisor---its-a-ceiling-problem-not-a-weight-problem-min-max-saturated-the-sci-axis-a-dupe-bug)
- [29ak. CEILING BUG CONFIRMED + ROOT CAUSE FOUND: integer-floored percentile ties the top ~1% at 100.](#29ak-ceiling-bug-confirmed-root-cause-found-integer-floored-percentile-ties-the-top-1-at-100)
- [29al. Calibration fix PARTIALLY worked - Patruno #2->#13 (proof it flows), but Girolomoni still #1, Silverberg #3.](#29al-calibration-fix-partially-worked---patruno-2-13-proof-it-flows-but-girolomoni-still-1-silverberg-3)
- [29am. REAL ROOT CAUSE - percentile_rank COLUMN IS INTEGER. Continuous values computed then ROUNDED on insert.](#29am-real-root-cause---percentile_rank-column-is-integer-continuous-values-computed-then-rounded-on-insert)
- [29an. Root cause pinned: ONLY hcp_publication_leadership_v2.percentile_rank is integer. One ALTER fixes it.](#29an-root-cause-pinned-only-hcp_publication_leadership_v2percentile_rank-is-integer-one-alter-fixes-it)
- [29ao. *** CALIBRATION CLOSED - SILVERBERG #1 GLOBALLY. The ranking is domain-perfect. *** ](#29ao-calibration-closed---silverberg-1-globally-the-ranking-is-domain-perfect-)
- [29ap. Eric Simpson dupe = SAME PERSON (OHSU), 2 OpenAlex IDs. Dedup correctly SKIPPED (common surname). Manual merge.](#29ap-eric-simpson-dupe-same-person-ohsu-2-openalex-ids-dedup-correctly-skipped-common-surname-manual-merge)
- [29aq. *** AD ESTABLISHED SCORING COMPLETE. *** Eric Simpson merged, final ranking validated, executing.](#29aq-ad-established-scoring-complete-eric-simpson-merged-final-ranking-validated-executing)
- [29ar. PERSISTED. hcp_established_ranks_v3: 2,546 global + 2,295 region = 4,841 rows. AD ESTABLISHED DONE.](#29ar-persisted-hcp_established_ranks_v3-2546-global-2295-region-4841-rows-ad-established-done)
- [30. FINALIZE-ESTABLISHED CHECKLIST (durable fixes - close the hidden regression risks).](#30-finalize-established-checklist-durable-fixes---close-the-hidden-regression-risks)
- [30a. A (schema DDL) DONE. A1: canonical DDL phase1_addendum_12_publication_leadership_v2.sql (double precision](#30a-a-schema-ddl-done-a1-canonical-ddl-phase1_addendum_12_publication_leadership_v2sql-double-precision)
- [30b. B1 RESOLVED - Step F fix is a USAGE fix, not a code change. Use --hcp-ids-file with ALL TA HCPs.](#30b-b1-resolved---step-f-fix-is-a-usage-fix-not-a-code-change-use---hcp-ids-file-with-all-ta-hcps)
- [30c. FINALIZE-ESTABLISHED COMPLETE. A+B+C done, D resolved.](#30c-finalize-established-complete-abc-done-d-resolved)
- [30d. RISING STARS - pipeline exists + ran for NSCLC/Hep, but writes to _v1 tables. Version question is load-bearing.](#30d-rising-stars---pipeline-exists-ran-for-nsclchep-but-writes-to-_v1-tables-version-question-is-load-bearing)
- [30e. Rising momentum scorers are V2-COMPATIBLE (good). _v1 is just legacy output-table naming.](#30e-rising-momentum-scorers-are-v2-compatible-good-_v1-is-just-legacy-output-table-naming)
- [30f. Rising Star model is a 2x2 (Momentum x Visibility), not just momentum. Frontend confirms - well-designed.](#30f-rising-star-model-is-a-2x2-momentum-x-visibility-not-just-momentum-frontend-confirms---well-designed)
- [30g. Rising build MAPPED - Visibility REUSES established scores (already built for AD). Only momentum to run.](#30g-rising-build-mapped---visibility-reuses-established-scores-already-built-for-ad-only-momentum-to-run)
- [30h. Rising pre-flight PASS. All percentiles numeric (no ceiling bug). Industry-class covers 4,187 AD HCPs.](#30h-rising-pre-flight-pass-all-percentiles-numeric-no-ceiling-bug-industry-class-covers-4187-ad-hcps)
- [30i. RISING MOMENTUM DRY-RUN = 14 eligible HCPs (of 5,925). COLLAPSE - eligibility bug. Dry-run saved us.](#30i-rising-momentum-dry-run-14-eligible-hcps-of-5925-collapse---eligibility-bug-dry-run-saved-us)
- [30j. ROOT CAUSE - momentum scorer IGNORES rising_eligible cohort + demands BOTH-window footprint. Design mismatch.](#30j-root-cause---momentum-scorer-ignores-rising_eligible-cohort-demands-both-window-footprint-design-mismatch)
- [30k. CONFIRMED - rising collapse is LINKAGE not design. User's "it worked for NSCLC" instinct VINDICATED.](#30k-confirmed---rising-collapse-is-linkage-not-design-users-it-worked-for-nsclc-instinct-vindicated)
- [30l. ALL 1,628 zero-link rising HCPs are IN the OpenAlex bridge -> 100% fixable by backfill. Re-run broader.](#30l-all-1628-zero-link-rising-hcps-are-in-the-openalex-bridge---100-fixable-by-backfill-re-run-broader)
- [30m. Backfill inserted NOTHING for rising (still 1,628 zero, median 3). NSCLC safe (481,944). Hypothesis wrong.](#30m-backfill-inserted-nothing-for-rising-still-1628-zero-median-3-nsclc-safe-481944-hypothesis-wrong)
- [30n. *** CONFIRMED: rising cohort NOT TA-anchored. Same bug class as established hepatologists. ***](#30n-confirmed-rising-cohort-not-ta-anchored-same-bug-class-as-established-hepatologists-)
- [30o. Rising pollution quantified: ~46% have <=2 AD pubs. Threshold decision for TA-anchoring rising.](#30o-rising-pollution-quantified-46-have-2-ad-pubs-threshold-decision-for-ta-anchoring-rising)
- [30p. Past-chat search on rising thresholds - found history but not exact values. Go to code + NSCLC data (ground truth).](#30p-past-chat-search-on-rising-thresholds---found-history-but-not-exact-values-go-to-code-nsclc-data-ground-truth)
- [30q. *** ROOT CAUSE PINNED IN CODE: rising path has NO ta_pubs gate (established does). + NSCLC never in v2 classifier. ***](#30q-root-cause-pinned-in-code-rising-path-has-no-ta_pubs-gate-established-does-nsclc-never-in-v2-classifier-)
- [30r. Advisor note drafted (rising thresholds). PROCEEDING with build while advisor out - decisions reversible.](#30r-advisor-note-drafted-rising-thresholds-proceeding-with-build-while-advisor-out---decisions-reversible)
- [30s. *** ADVISOR: don't retune momentum - REDESIGN it for Rising. Different philosophy, not different thresholds. ***](#30s-advisor-dont-retune-momentum---redesign-it-for-rising-different-philosophy-not-different-thresholds-)
- [30t. ta_pubs gate WORKS. rising 5,925 -> 3,234. Clean, auditable demotion. + established drifted +38 (backfill).](#30t-ta_pubs-gate-works-rising-5925---3234-clean-auditable-demotion-established-drifted-38-backfill)
- [30u. Classification PERSISTED + all checks pass. Decision: B (clean-sheet emergence_scoring.py).](#30u-classification-persisted-all-checks-pass-decision-b-clean-sheet-emergence_scoringpy)
- [30v. ADVISOR sharpened Emergence: citations-PER-PUB (not total), DROP network entirely. 3-construct model.](#30v-advisor-sharpened-emergence-citations-per-pub-not-total-drop-network-entirely-3-construct-model)
- [30w. BUILT emergence_scoring.py + DDL. Ready to run.](#30w-built-emergence_scoringpy-ddl-ready-to-run)
- [30x. Emergence dry-run: PLAUSIBLE list, passes academic-age test. But INDUSTRY names leaking (no academic filter).](#30x-emergence-dry-run-plausible-list-passes-academic-age-test-but-industry-names-leaking-no-academic-filter)
- [30y. Industry-filter decision RESOLVED by data: rising cohort is 99.8% UNCLASSIFIED (3,227/3,234). Don't filter.](#30y-industry-filter-decision-resolved-by-data-rising-cohort-is-998-unclassified-32273234-dont-filter)
- [30z. Hagino edge-case spot-check PASSES - real hyper-productive early-career AD investigator, not an artifact.](#30z-hagino-edge-case-spot-check-passes---real-hyper-productive-early-career-ad-investigator-not-an-artifact)
- [30aa. Emergence EXECUTED (3,052 scored, clean spread). Rising composite: use 10yr network (recent window not computed).](#30aa-emergence-executed-3052-scored-clean-spread-rising-composite-use-10yr-network-recent-window-not-computed)
- [30ab. SCHEMA CLARIFICATION - hcp_rising_star_ranks_v3 ALREADY EXISTS with OLD 2x2 shape. My CREATE was a no-op.](#30ab-schema-clarification---hcp_rising_star_ranks_v3-already-exists-with-old-2x2-shape-my-create-was-a-no-op)
- [30ac. hcp_rising_star_ranks_v3 has 1,581 NSCLC rows (FROZEN) - DO NOT DROP. New table hcp_rising_composite_v1.](#30ac-hcp_rising_star_ranks_v3-has-1581-nsclc-rows-frozen---do-not-drop-new-table-hcp_rising_composite_v1)
- [30ad. THE RISING->ESTABLISHED LEAP: it's TIME, not substance. Top rising already exceed the established floor.](#30ad-the-rising-established-leap-its-time-not-substance-top-rising-already-exceed-the-established-floor)
- [30ae. DESIGN ISSUE (user-surfaced): established gate uses career_age>10 as a LAZY PROXY for authority. Misclassifies at margins.](#30ae-design-issue-user-surfaced-established-gate-uses-career_age10-as-a-lazy-proxy-for-authority-misclassifies-at-margins)
- [30af. RISING COMPOSITE validated - Chovatiya emergence#4 -> composite#1 (network lifted the both-axes leader).](#30af-rising-composite-validated---chovatiya-emergence4---composite1-network-lifted-the-both-axes-leader)
- [30ag. ADVISOR sharpened the established-gate insight: career_age is a proxy for DURABILITY (not a weak proxy for authority). Upgrades §30ae.](#30ag-advisor-sharpened-the-established-gate-insight-career_age-is-a-proxy-for-durability-not-a-weak-proxy-for-authority-upgrades-30ae)
- [30ah. *** RISING STARS PERSISTED. hcp_rising_composite_v1: 3,052 global + 2,667 region = 5,719 rows. DONE. ***](#30ah-rising-stars-persisted-hcp_rising_composite_v1-3052-global-2667-region-5719-rows-done-)
- [30ai. COMMUNITY construct REVEALED by frontend - it's COMMERCIAL/CLINICAL engagement, not scientific. Different data spine.](#30ai-community-construct-revealed-by-frontend---its-commercialclinical-engagement-not-scientific-different-data-spine)
- [30aj. Community data spine FOUND (Medicare + Open Payments). Scorer exists. But US-DEPENDENT - AD is 73% intl.](#30aj-community-data-spine-found-medicare-open-payments-scorer-exists-but-us-dependent---ad-is-73-intl)
- [30aj-CORRECTION. Heymach is NSCLC - does NOT confirm AD scoring is live. Correcting §30aj.](#30aj-correction-heymach-is-nsclc---does-not-confirm-ad-scoring-is-live-correcting-30aj)
- [30ak. COMMUNITY for AD is BLOCKED on Medicare ingestion. Not a scoring build - a data build. 0 AD Medicare rows.](#30ak-community-for-ad-is-blocked-on-medicare-ingestion-not-a-scoring-build---a-data-build-0-ad-medicare-rows)
- [30al. Community-for-AD is a REAL PROJECT, not a quick run. 3 compounding problems. RECOMMEND checkpoint.](#30al-community-for-ad-is-a-real-project-not-a-quick-run-3-compounding-problems-recommend-checkpoint)
- [30am. REFRAME: Community blocker is the ta_hcpcs_codes MAPPING for AD (missing), NOT the data. Much more tractable.](#30am-reframe-community-blocker-is-the-ta_hcpcs_codes-mapping-for-ad-missing-not-the-data-much-more-tractable)
- [30an. NSCLC codes = 41, mostly specialty-match (30/41). AD-tractable pattern BUT needs CLINICAL HCPCS CURATION.](#30an-nsclc-codes-41-mostly-specialty-match-3041-ad-tractable-pattern-but-needs-clinical-hcpcs-curation)
- [30ao. PAST-CHAT FINDINGS on Community: full formula + the scorer runs on Open Payments ALONE (Medicare not hard-required).](#30ao-past-chat-findings-on-community-full-formula-the-scorer-runs-on-open-payments-alone-medicare-not-hard-required)
- [30ap. NSCLC community = PATIENT-VOLUME construct (Hussein 9,992 patients #1, scope_size 6,480). AD needs Medicare. DRAFT derm HCPCS.](#30ap-nsclc-community-patient-volume-construct-hussein-9992-patients-1-scope_size-6480-ad-needs-medicare-draft-derm-hcpcs)
- [30aq. ADVISOR (pt1): Community is DISEASE-DEPENDENT. Don't rank it - make it "Community EXPLORER" (search, not score).](#30aq-advisor-pt1-community-is-disease-dependent-dont-rank-it---make-it-community-explorer-search-not-score)
- [30ar. *** ADVISOR (pt2): THE ARCHITECTURAL INSIGHT - FieldMark has TWO kinds of intelligence. Scientific=global, Operational=local. ***](#30ar-advisor-pt2-the-architectural-insight---fieldmark-has-two-kinds-of-intelligence-scientificglobal-operationallocal-)
- [30as. Community Explorer DATA GAP = NPPES enrichment. US filter dimensions almost entirely EMPTY. Ingestion identified.](#30as-community-explorer-data-gap-nppes-enrichment-us-filter-dimensions-almost-entirely-empty-ingestion-identified)
- [30at. community_nppes_backfill.py enriches HCPs that ALREADY HAVE an NPI - doesn't FIND NPIs. The gap is upstream: NPI RESOLUTION.](#30at-community_nppes_backfillpy-enriches-hcps-that-already-have-an-npi---doesnt-find-npis-the-gap-is-upstream-npi-resolution)
- [30au. SEQUENCING ISSUE (Garrett-flagged): NPI enrichment was demand-driven, never cohort-wide. Community classified before its data exists.](#30au-sequencing-issue-garrett-flagged-npi-enrichment-was-demand-driven-never-cohort-wide-community-classified-before-its-data-exists)
- [30av. CORRECTION: NPPES RESOLUTION TOOLKIT ALREADY EXISTS. Not a build - a run-for-AD-community. + gap audit utility.](#30av-correction-nppes-resolution-toolkit-already-exists-not-a-build---a-run-for-ad-community-gap-audit-utility)
- [30aw. npi_gap_audit.py reads the V1 table `hcps` (not hcps_v2) - the NPPES toolkit is (at least partly) V1-ERA.](#30aw-npi_gap_auditpy-reads-the-v1-table-hcps-not-hcps_v2---the-nppes-toolkit-is-at-least-partly-v1-era)
- [30ax. nppes_matcher.py READ (screenshots): it's V1 (reads `hcps`) BUT SAFE - writes PROPOSALS not NPIs. Well-built, conservative.](#30ax-nppes_matcherpy-read-screenshots-its-v1-reads-hcps-but-safe---writes-proposals-not-npis-well-built-conservative)
- [30ay. Matcher dry-run: 676 eligible, only 30 Tier1+2, but 604 NO_MATCH (89%) - SUSPICIOUSLY HIGH. Likely state-format bug.](#30ay-matcher-dry-run-676-eligible-only-30-tier12-but-604-no_match-89---suspiciously-high-likely-state-format-bug)
- [30az. 89% no_match EXPLAINED - the AD community cohort is full of ACADEMIC RESEARCHERS (hepatologists!), not US clinicians. Not a matcher bug.](#30az-89-no_match-explained---the-ad-community-cohort-is-full-of-academic-researchers-hepatologists-not-us-clinicians-not-a-matcher-bug)
- [30ba. *** DEFINITIVE: the AD community cohort contains ~2 dermatologists. The US community derms were NEVER INGESTED. ***](#30ba-definitive-the-ad-community-cohort-contains-2-dermatologists-the-us-community-derms-were-never-ingested-)
- [30bb. *** 17,274 US DERMATOLOGISTS in the NPPES parquet. The AD Community population EXISTS - just never ingested. ***](#30bb-17274-us-dermatologists-in-the-nppes-parquet-the-ad-community-population-exists---just-never-ingested-)
- [30bc. CONFIRMED: FieldMark has ~50 derms; parquet has 17,274. ~17,200 net-new. NPI join clean. This IS the community build.](#30bc-confirmed-fieldmark-has-50-derms-parquet-has-17274-17200-net-new-npi-join-clean-this-is-the-community-build)
- [30bd. SEQUENCING DOCTRINE (consolidated) - the AD build's dependency lessons, learned by hitting walls. FOR THE PLAYBOOK.](#30bd-sequencing-doctrine-consolidated---the-ad-builds-dependency-lessons-learned-by-hitting-walls-for-the-playbook)
- [30be. Community derm ingestion dry-run VALIDATED: 19,351 US derms, 19,009 net-new. Executing.](#30be-community-derm-ingestion-dry-run-validated-19351-us-derms-19009-net-new-executing)
- [30bf. *** OPERATIONAL SPINE LIVE. community_practitioners: 19,351 US derms (19,009 net-new, 259 peds, 56 states). ***](#30bf-operational-spine-live-community_practitioners-19351-us-derms-19009-net-new-259-peds-56-states-)
- [30bg. Open Payments parquets on disk + HAVE NPI. Clean join to community derms. Pharma layer = tractable aggregation.](#30bg-open-payments-parquets-on-disk-have-npi-clean-join-to-community-derms-pharma-layer-tractable-aggregation)
- [30bh. AD drug list finalized (12) + ADVISOR: make it a ta_drug_keywords TABLE, not hardcoded. Config-not-code (like ta_hcpcs_codes).](#30bh-ad-drug-list-finalized-12-advisor-make-it-a-ta_drug_keywords-table-not-hardcoded-config-not-code-like-ta_hcpcs_codes)
- [30bi. ta_drug_keywords ALREADY populated for AD (14 rows) - covers all 12 + 2 pipeline flagged is_primary_signal=false. No insert.](#30bi-ta_drug_keywords-already-populated-for-ad-14-rows---covers-all-12-2-pipeline-flagged-is_primary_signalfalse-no-insert)
- [30bj. No new parquets for AD Open Payments - the files are UNIVERSAL (all physicians/drugs). TA-specificity is at QUERY time.](#30bj-no-new-parquets-for-ad-open-payments---the-files-are-universal-all-physiciansdrugs-ta-specificity-is-at-query-time)
- [30bk. Community Open Payments dry-run VALIDATED: 73% have payments, AD-drug $ mirrors real market. Executing.](#30bk-community-open-payments-dry-run-validated-73-have-payments-ad-drug-mirrors-real-market-executing)
- [30bl. Cross-TA community geography: AD-derm vs NSCLC-onc state distributions differ in ways that TRACK THE MEDICINE.](#30bl-cross-ta-community-geography-ad-derm-vs-nsclc-onc-state-distributions-differ-in-ways-that-track-the-medicine)
- [30bm. BACKEND STATUS CHECK (Garrett asked "are we done"): Scientific 100%, Community ~80%. Precise remaining list.](#30bm-backend-status-check-garrett-asked-are-we-done-scientific-100-community-80-precise-remaining-list)
- [30bn. Frontend surface understood + career_stage confirmed. Community tab = the Explorer's home. Design tension: directory in a leaderboard UI.](#30bn-frontend-surface-understood-career_stage-confirmed-community-tab-the-explorers-home-design-tension-directory-in-a-leaderboard-ui)
- [30bo. "Who to connect with first" WITHOUT claims data - the honest proxy: AD-ENGAGEMENT DEPTH, framed as engagement not clinical value.](#30bo-who-to-connect-with-first-without-claims-data---the-honest-proxy-ad-engagement-depth-framed-as-engagement-not-clinical-value)
- [30bp. ADVISOR (1 of 2) on the Explorer: surface OPPORTUNITY, not activity. Community -> "Field Opportunity" with a score.](#30bp-advisor-1-of-2-on-the-explorer-surface-opportunity-not-activity-community---field-opportunity-with-a-score)
- [30bq. ADVISOR (2 of 2) + RECONCILIATION: Community is a WORKSPACE (execution product), not a cohort. "Field Opportunity" resolves the ranking tension.](#30bq-advisor-2-of-2-reconciliation-community-is-a-workspace-execution-product-not-a-cohort-field-opportunity-resolves-the-ranking-tension)
- [30br. FIELD OPPORTUNITY v1 score design - from the signal inventory. Key Q: scientific BAKED-IN vs BADGE.](#30br-field-opportunity-v1-score-design---from-the-signal-inventory-key-q-scientific-baked-in-vs-badge)
- [30bs. ADVISOR (resolves bake-vs-badge by DISSOLVING it): NO single Community score yet. MULTI-DIMENSIONAL opportunity. Composite emerges from EVIDENCE later.](#30bs-advisor-resolves-bake-vs-badge-by-dissolving-it-no-single-community-score-yet-multi-dimensional-opportunity-composite-emerges-from-evidence-later)
- [30bt. BUILT Community Workspace prototype v2 (CommunityWorkspace.jsx) - multi-dimensional, strategy-sorted, no composite.](#30bt-built-community-workspace-prototype-v2-communityworkspacejsx---multi-dimensional-strategy-sorted-no-composite)
- [30bu. Workspace v2 LOVED. v3 spec from advisor reaction. DECISION: KEEP STARS + always-visible evidence (option 1).](#30bu-workspace-v2-loved-v3-spec-from-advisor-reaction-decision-keep-stars-always-visible-evidence-option-1)
- [30bv. v3 reaction: Practice Setting = CONTEXT not signal (drop its stars). "Why recommended" drawer. + the priority ranking of the whole build.](#30bv-v3-reaction-practice-setting-context-not-signal-drop-its-stars-why-recommended-drawer-the-priority-ranking-of-the-whole-build)
- [30bw. *** THE CENTRAL PRODUCT INSIGHT: Community is the MAP (static, planning). FIELD INTELLIGENCE is the HEARTBEAT (daily, what CHANGED). ***](#30bw-the-central-product-insight-community-is-the-map-static-planning-field-intelligence-is-the-heartbeat-daily-what-changed-)
- [30bx. SESSION END. Kickoff note + Claude Code frontend audit prompt written. Tomorrow = frontend audit -> AD repoint. Adopting Claude Code.](#30bx-session-end-kickoff-note-claude-code-frontend-audit-prompt-written-tomorrow-frontend-audit---ad-repoint-adopting-claude-code)
- [30by. FRONTEND AUDIT (Claude Code, live-verified). Lift: Established Small, Rising Medium, Community Large/separate. + RLS LAUNCH BLOCKER found.](#30by-frontend-audit-claude-code-live-verified-lift-established-small-rising-medium-community-largeseparate-rls-launch-blocker-found)
- [30bz. RLS LOCKDOWN RUN + VERIFIED. Launch blocker CLEARED. Anon locked out of all 4 new AD tables.](#30bz-rls-lockdown-run-verified-launch-blocker-cleared-anon-locked-out-of-all-4-new-ad-tables)
- [30ca. AD Established frontend diff REVIEWED + approved (Claude Code, plan mode). Replace variant. 5 files/11 edits, NSCLC-safe.](#30ca-ad-established-frontend-diff-reviewed-approved-claude-code-plan-mode-replace-variant-5-files11-edits-nsclc-safe)
- [30cb. *** AD ESTABLISHED IS LIVE IN THE FRONTEND. Verified in-browser, logged in. Rankings domain-correct. ***](#30cb-ad-established-is-live-in-the-frontend-verified-in-browser-logged-in-rankings-domain-correct-)
- [30cc. GAP FOUND: AD Established has almost NO practice-location data (8 of 5,131 have nppes_practice_state) + NO region-scope rows. Territory filtering is hollow.](#30cc-gap-found-ad-established-has-almost-no-practice-location-data-8-of-5131-have-nppes_practice_state-no-region-scope-rows-territory-filtering-is-hollow)
- [30cd. RESTRUCTURE: AD = indication under IMMUNOLOGY (not top-level chip). Trace revealed Oncology->NSCLC is a FAÇADE.](#30cd-restructure-ad-indication-under-immunology-not-top-level-chip-trace-revealed-oncology-nsclc-is-a-façade)
- [30ce. DECISION REVERSED (Garrett pushed): do OPTION B now (real per-indication ta_id), not A-then-B.](#30ce-decision-reversed-garrett-pushed-do-option-b-now-real-per-indication-ta_id-not-a-then-b)
- [30cf. OPTION B plan REVIEWED. Guardrail airtight. DECISIONS: (a) "All"=recommended (AD taId), (b) thread taId into DETAIL page NOW (don't defer).](#30cf-option-b-plan-reviewed-guardrail-airtight-decisions-a-allrecommended-ad-taid-b-thread-taid-into-detail-page-now-dont-defer)
- [30cg. BUG: AD detail page still parent-scoped - Silverberg (#1 in feed) shows "Unclassified" on his profile. Decision-(b) threading didn't fully land.](#30cg-bug-ad-detail-page-still-parent-scoped---silverberg-1-in-feed-shows-unclassified-on-his-profile-decision-b-threading-didnt-fully-land)
- [30ch. SEQUENCING: NPPES practice-state resolution MUST precede narrative generation (narratives reference location).](#30ch-sequencing-nppes-practice-state-resolution-must-precede-narrative-generation-narratives-reference-location)
- [30ci. Detail-page bug = TWO breaks (not one). Fix reviewed + approved. + FLAG: duplicate global rows in hcp_established_ranks_v3.](#30ci-detail-page-bug-two-breaks-not-one-fix-reviewed-approved-flag-duplicate-global-rows-in-hcp_established_ranks_v3)
- [30cj. DETAIL-PAGE FIX VERIFIED in-browser. AD drill-down works end-to-end. Committing.](#30cj-detail-page-fix-verified-in-browser-ad-drill-down-works-end-to-end-committing)
- [30ck. Two diagnostics: (1) dup global rows are SYSTEMIC (not Silverberg-only); (2) NSCLC Established practice-state = only 20% - the State fix = replicate NSCLC's NPI-resolution for AD.](#30ck-two-diagnostics-1-dup-global-rows-are-systemic-not-silverberg-only-2-nsclc-established-practice-state-only-20---the-state-fix-replicate-nsclcs-npi-resolution-for-ad)
- [30cl. State-fix trace: NSCLC's practice-states came from a SUPERSEDED all-cohort script (nppes_enrichment.py); no v2 script covers Established. Fix = populate nppes_practice_state. + FAST PATH via community_practitioners.](#30cl-state-fix-trace-nsclcs-practice-states-came-from-a-superseded-all-cohort-script-nppes_enrichmentpy-no-v2-script-covers-established-fix-populate-nppes_practice_state-fast-path-via-community_practitioners)
- [30cm. Coverage reality: AD Established has only 171/2,585 NPIs (7%). Bottleneck = NPI, not state. Fast path = 90 free via community join. Full = risky name-match.](#30cm-coverage-reality-ad-established-has-only-1712585-npis-7-bottleneck-npi-not-state-fast-path-90-free-via-community-join-full-risky-name-match)
- [30cn. State fast-path DONE: AD Established practice-state 6 -> 96 via free community_practitioners NPI join. Verified names/locations correct.](#30cn-state-fast-path-done-ad-established-practice-state-6---96-via-free-community_practitioners-npi-join-verified-nameslocations-correct)
- [30co. STRATEGIC FINDING: AD Established is an INTERNATIONAL academic cohort - 78% of no-NPI HCPs are non-US. US-territory filtering has a hard ceiling AD doesn't share with NSCLC. Dry-run (no writes).](#30co-strategic-finding-ad-established-is-an-international-academic-cohort---78-of-no-npi-hcps-are-non-us-us-territory-filtering-has-a-hard-ceiling-ad-doesnt-share-with-nsclc-dry-run-no-writes)
- [30cp. NPI dry-run v2b: taxonomy ALLOW-LIST is the key - 67 clean high-confidence (was 25). Ambiguous 101->2. Reviewing 67 via CSV before write.](#30cp-npi-dry-run-v2b-taxonomy-allow-list-is-the-key---67-clean-high-confidence-was-25-ambiguous-101-2-reviewing-67-via-csv-before-write)
- [30cq. NPI CSV review: add INDUSTRY-affiliation flag (Claude Code caught David Berk/Atara -> clinical NPI false-positive risk). Review flagged + location-mismatch scan.](#30cq-npi-csv-review-add-industry-affiliation-flag-claude-code-caught-david-berkatara---clinical-npi-false-positive-risk-review-flagged-location-mismatch-scan)
- [30cr. NPI flagged-row review: DECISION PRINCIPLE = location-match trumps candidate-count. Keep 7, drop 8 of the 15 flagged. + 52 unflagged clean.](#30cr-npi-flagged-row-review-decision-principle-location-match-trumps-candidate-count-keep-7-drop-8-of-the-15-flagged-52-unflagged-clean)
- [30cs. NPI write dry-run: 57 to write (2 excluded = duplicate-HCP-record KOLs). GO for execute. 96 -> ~153 coverage.](#30cs-npi-write-dry-run-57-to-write-2-excluded-duplicate-hcp-record-kols-go-for-execute-96---153-coverage)
- [30ct. NPI/state write DONE + verified: 96->153 practice-state, 171->228 NPI. State work complete (at US ceiling). 3 dup symptoms = 1 root cause.](#30ct-npistate-write-done-verified-96-153-practice-state-171-228-npi-state-work-complete-at-us-ceiling-3-dup-symptoms-1-root-cause)
- [30cu. AD profile-components diagnosis: 1 scoping bug to fix NOW (hardcoded NSCLC), rest = the ENRICHMENT/SYNTHESIS LAYER never run for AD.](#30cu-ad-profile-components-diagnosis-1-scoping-bug-to-fix-now-hardcoded-nsclc-rest-the-enrichmentsynthesis-layer-never-run-for-ad)
- [30cv. Enrichment scope: Top 200 each of Established/Rising/Community. FLAG: enrichment layer is PUBLICATION-DERIVED - fits Established+Rising, probably NOT Community.](#30cv-enrichment-scope-top-200-each-of-establishedrisingcommunity-flag-enrichment-layer-is-publication-derived---fits-establishedrising-probably-not-community)
- [30cw. Community narrative: Garrett wants top-by-patient-volume -> narrative. REALITY: no volume data (claims unaffordable). Proxy = AD engagement. Narrative = OPERATIONAL (not publication).](#30cw-community-narrative-garrett-wants-top-by-patient-volume---narrative-reality-no-volume-data-claims-unaffordable-proxy-ad-engagement-narrative-operational-not-publication)
- [30cx. Dedup task_c0e748c8 -> do BEFORE enrichment (enrichment selects top-200 from this table). Investigate read-only first.](#30cx-dedup-task_c0e748c8---do-before-enrichment-enrichment-selects-top-200-from-this-table-investigate-read-only-first)
- [30cy. Narrative generator analysis: SLUG MISMATCH (must fix frontend read first) + RISING INCOMPATIBLE (script change needed). Established-only now.](#30cy-narrative-generator-analysis-slug-mismatch-must-fix-frontend-read-first-rising-incompatible-script-change-needed-established-only-now)
- [30cz. Dedup investigation: AD-ONLY (NSCLC clean), 2,546 exact global pairs from a partial recompute re-run. Discriminator = computed_at. Draft dry-run.](#30cz-dedup-investigation-ad-only-nsclc-clean-2546-exact-global-pairs-from-a-partial-recompute-re-run-discriminator-computed_at-draft-dry-run)
- [30da. Dedup ROOT CAUSE found (better than expected): NULLS-DISTINCT constraint let global(NULL scope_value) rows escape the existing upsert. Fix = NULLS NOT DISTINCT constraint swap. Migration-file.](#30da-dedup-root-cause-found-better-than-expected-nulls-distinct-constraint-let-globalnull-scope_value-rows-escape-the-existing-upsert-fix-nulls-not-distinct-constraint-swap-migration-file)
- [30db. DEDUP DONE + VERIFIED. AD ranks_v3 global 5,131->2,585 distinct (one row/HCP). Constraint swapped to NULLS NOT DISTINCT. Recurrence structurally prevented.](#30db-dedup-done-verified-ad-ranks_v3-global-5131-2585-distinct-one-rowhcp-constraint-swapped-to-nulls-not-distinct-recurrence-structurally-prevented)
- [30dc. Narrative slug fix REVIEWED + approved. Two read sites, both backward-compat. (Fresh Code session.)](#30dc-narrative-slug-fix-reviewed-approved-two-read-sites-both-backward-compat-fresh-code-session)
- [30dd. Narrative dry-run: CLEAN + high quality. Blast radius = AD-only (freshness-skipped the 5 non-AD). Sample (Lio) reads excellently. Proceed to real 5.](#30dd-narrative-dry-run-clean-high-quality-blast-radius-ad-only-freshness-skipped-the-5-non-ad-sample-lio-reads-excellently-proceed-to-real-5)
- [30de. DESIGN DEBT: generate_narratives_v2.py TA-scoping is not future-proof (implicit via config-visibility + freshness-skip, no --ta flag). Fix later, fine for today.](#30de-design-debt-generate_narratives_v2py-ta-scoping-is-not-future-proof-implicit-via-config-visibility-freshness-skip-no---ta-flag-fix-later-fine-for-today)
- [30df. NARRATIVE RENDERS - slug fix WORKS end-to-end (Guttman-Yassky "Why This Expert" shows real text). The "two narratives" = two FIELDS by design (card=why_now teaser, detail=narrative), consistent w/ NSCLC.](#30df-narrative-renders---slug-fix-works-end-to-end-guttman-yassky-why-this-expert-shows-real-text-the-two-narratives-two-fields-by-design-cardwhy_now-teaser-detailnarrative-consistent-w-nsclc)
- [30dg. UX ISSUE (real, worth fixing): card teaser = why_now (truncated, DEAD-ENDS - appears nowhere else, can't expand). Likely defect: why_now displayed ONLY on card. Decide design.](#30dg-ux-issue-real-worth-fixing-card-teaser-why_now-truncated-dead-ends---appears-nowhere-else-cant-expand-likely-defect-why_now-displayed-only-on-card-decide-design)
- [30dh. Field->UI trace: 4 of 5 narrative fields dead-end or invisible for ESTABLISHED. Two root causes. Fix = un-gate Signal Summary + add why_now to detail mapping.](#30dh-field-ui-trace-4-of-5-narrative-fields-dead-end-or-invisible-for-established-two-root-causes-fix-un-gate-signal-summary-add-why_now-to-detail-mapping)
- [30di. Signal Summary fix APPROVED. 2 small diffs, empty-field-hiding already clean, backward-compat. Nuance: why_now was blank for ALL cohorts (fix helps rising stars too).](#30di-signal-summary-fix-approved-2-small-diffs-empty-field-hiding-already-clean-backward-compat-nuance-why_now-was-blank-for-all-cohorts-fix-helps-rising-stars-too)
- [30dj. Signal Summary fix APPLIED + verified (typecheck 70 baseline / build green). The "new" error was pre-existing :1589 ternary shifted to :1587 (Fix 2 collapsed 3->1 line, -2 lines). AD profiles now show full briefing.](#30dj-signal-summary-fix-applied-verified-typecheck-70-baseline-build-green-the-new-error-was-pre-existing-1589-ternary-shifted-to-1587-fix-2-collapsed-3-1-line--2-lines-ad-profiles-now-show-full-briefing)
- [30dk. Signal Summary WORKS (content excellent) but SIGNAL BADGE OVERFLOWS: signal_strength is a full SENTENCE stuffed in a BADGE component -> horizontal overflow across screen.](#30dk-signal-summary-works-content-excellent-but-signal-badge-overflows-signal_strength-is-a-full-sentence-stuffed-in-a-badge-component---horizontal-overflow-across-screen)
- [30dl. NARRATIVE RUN COMPLETE: 198 AD Established narratives generated (2 failures ~1%, transient), 34 min, $1.10.](#30dl-narrative-run-complete-198-ad-established-narratives-generated-2-failures-1-transient-34-min-110)
- [30dm. signal_strength overflow fix APPROVED: root cause = flexShrink:0 span in space-between flex row. Fix = render as wrapping prose div like sibling fields.](#30dm-signal_strength-overflow-fix-approved-root-cause-flexshrink0-span-in-space-between-flex-row-fix-render-as-wrapping-prose-div-like-sibling-fields)
- [30dn. signal_strength overflow FIXED + verified (renders clean, wraps in column). Content excellent. Minor polish: add yellow left-border accent to Signal Summary to match Why This Expert.](#30dn-signal_strength-overflow-fixed-verified-renders-clean-wraps-in-column-content-excellent-minor-polish-add-yellow-left-border-accent-to-signal-summary-to-match-why-this-expert)
- [30do. Starting BELIEF PROFILE enrichment (hcp_ai_overviews, scientific-positions synthesis -> ScientificNarrativeSection). TAG MATCH is the key risk (trickier than narratives).](#30do-starting-belief-profile-enrichment-hcp_ai_overviews-scientific-positions-synthesis---scientificnarrativesection-tag-match-is-the-key-risk-trickier-than-narratives)
- [30dp. Belief Profile trace: BIGGER than narratives. TWO-stage NSCLC-hardcoded pipeline. Tag mismatch confirmed. Needs TA-parameterization of BOTH stages. ~$25-70 for top-100.](#30dp-belief-profile-trace-bigger-than-narratives-two-stage-nsclc-hardcoded-pipeline-tag-mismatch-confirmed-needs-ta-parameterization-of-both-stages-25-70-for-top-100)
- [30dq. AD positions = 0 confirmed (Stage 1 must run fresh). COST estimate suspect - Garrett's instinct: NSCLC didn't cost this much. Read the actual paper-cap before costing.](#30dq-ad-positions-0-confirmed-stage-1-must-run-fresh-cost-estimate-suspect---garretts-instinct-nsclc-didnt-cost-this-much-read-the-actual-paper-cap-before-costing)
- [30dr. COST RECONCILED via past-chat search: Garrett's memory correct. Belief Profile reads PRE-STORED abstracts, ~$25 (not $20-60). Paper cap ~10/HCP confirmed.](#30dr-cost-reconciled-via-past-chat-search-garretts-memory-correct-belief-profile-reads-pre-stored-abstracts-25-not-20-60-paper-cap-10hcp-confirmed)
- [30ds. AD corpus confirmed: 19,047 AD pubs w/ abstracts (publications_v2.abstract, source_therapeutic_area_id). Ample. Cost hinges ENTIRELY on the paper cap.](#30ds-ad-corpus-confirmed-19047-ad-pubs-w-abstracts-publications_v2abstract-source_therapeutic_area_id-ample-cost-hinges-entirely-on-the-paper-cap)
- [30dt. Belief Profile toolkit FULLY READ. Cost ~$15 (Garrett right). TWO key findings beyond cost: Stage 1 NOT idempotent; SOFT prompt contamination (NSCLC drug exemplars) = quality risk needing AD-specific rework (advisor load-bearing).](#30dt-belief-profile-toolkit-fully-read-cost-15-garrett-right-two-key-findings-beyond-cost-stage-1-not-idempotent-soft-prompt-contamination-nsclc-drug-exemplars-quality-risk-needing-ad-specific-rework-advisor-load-bearing)
- [30du. NSCLC precedent recovered: B (AD-specific exemplars) IS the robust approach = Garrett writes AD position examples (as he did for NSCLC). Typology is TA-agnostic (his design); only EXAMPLES are TA-specific. Ship founder-authored now, advisor validates later.](#30du-nsclc-precedent-recovered-b-ad-specific-exemplars-is-the-robust-approach-garrett-writes-ad-position-examples-as-he-did-for-nsclc-typology-is-ta-agnostic-his-design-only-examples-are-ta-specific-ship-founder-authored-now-advisor-validates-later)
- [30dv. CORRECTION (Garrett): the NSCLC prompt exemplars were NOT founder-authored. Garrett is not a scientist. The EXTRACTED positions are abstract-derived (correct); the prompt EXEMPLARS are teaching-examples (likely Claude/Cursor-written when pipeline built). De-contamination should NOT require Garrett to author clinical claims.](#30dv-correction-garrett-the-nsclc-prompt-exemplars-were-not-founder-authored-garrett-is-not-a-scientist-the-extracted-positions-are-abstract-derived-correct-the-prompt-exemplars-are-teaching-examples-likely-claudecursor-written-when-pipeline-built-de-contamination-should-not-require-garrett-to-author-clinical-claims)
- [30dw. Belief Profile parameterization REVIEWED - excellent. Per-TA registry (TA_CONFIGS), TA-neutral exemplars, tag=atopic-dermatitis, Stage-1 idempotency, NSCLC byte-for-byte. Approve -> test-5.](#30dw-belief-profile-parameterization-reviewed---excellent-per-ta-registry-ta_configs-ta-neutral-exemplars-tagatopic-dermatitis-stage-1-idempotency-nsclc-byte-for-byte-approve---test-5)
- [30dx. DEMO VIDEO to re-record (Garrett) - but AFTER enrichment complete, not now. Signal Summary + full enrichment stack = the demo-worthy profile.](#30dx-demo-video-to-re-record-garrett---but-after-enrichment-complete-not-now-signal-summary-full-enrichment-stack-the-demo-worthy-profile)
- [30dy. Belief Profile test-5: applied + AD extraction quality EXCELLENT (the neutral-exemplar bet paid off) + NSCLC byte-identity PROVEN. Stage 1 running.](#30dy-belief-profile-test-5-applied-ad-extraction-quality-excellent-the-neutral-exemplar-bet-paid-off-nsclc-byte-identity-proven-stage-1-running)
- [30dz. Belief Profile test-5 COMPLETE + confirmed. 249 positions (healthy polarity spread), 5 profiles all depth=deep, genuine AD themes, tag=atopic-dermatitis on all 5. Verify render on Guttman-Yassky.](#30dz-belief-profile-test-5-complete-confirmed-249-positions-healthy-polarity-spread-5-profiles-all-depthdeep-genuine-ad-themes-tagatopic-dermatitis-on-all-5-verify-render-on-guttman-yassky)
- [30ea. OPERATIONAL RULE (Garrett): run LONG enrichment jobs directly in Garrett's terminal, NOT as Code background jobs. Live progress vs buffered blackout.](#30ea-operational-rule-garrett-run-long-enrichment-jobs-directly-in-garretts-terminal-not-as-code-background-jobs-live-progress-vs-buffered-blackout)
- [30eb. Verified: Code WAS already running full Belief Profile Stage 1 (job bkivbkcyk, 15:58:29, ~9/100 HCPs, 409 positions, healthy). Garrett right to check first (would've been 2 racing processes). DECISION: A - leave it running.](#30eb-verified-code-was-already-running-full-belief-profile-stage-1-job-bkivbkcyk-155829-9100-hcps-409-positions-healthy-garrett-right-to-check-first-wouldve-been-2-racing-processes-decision-a---leave-it-running)
- [30ec. PARITY MATRIX (live-DB measured) = AD definition-of-done. AD Established near-done (cleaner than NSCLC on core layers); AD Rising ENTIRELY UNBUILT (one blocker: rising scoring chain never ran).](#30ec-parity-matrix-live-db-measured-ad-definition-of-done-ad-established-near-done-cleaner-than-nsclc-on-core-layers-ad-rising-entirely-unbuilt-one-blocker-rising-scoring-chain-never-ran)
- [30ed. Parity checklist saved to docs/AD_PARITY_CHECKLIST.md (108 lines, 4-col matrix + punch-list + reading guide, dated 2026-07-10, Belief Profiles mid-generation at snapshot). Committing ("docs: AD enrichment parity checklist vs NSCLC"). Running docs published for Garrett to save locally.](#30ed-parity-checklist-saved-to-docsad_parity_checklistmd-108-lines-4-col-matrix-punch-list-reading-guide-dated-2026-07-10-belief-profiles-mid-generation-at-snapshot-committing-docs-ad-enrichment-parity-checklist-vs-nsclc-running-docs-published-for-garrett-to-save-locally)
- [30ee. BELIEF PROFILE FULL RUN COMPLETE (both stages, 0 errors). 87/87 profiles, tagged atopic-dermatitis. 30.8 positions/HCP matches NSCLC baseline 35.1 (Gate 14 holds at scale). Idempotency held (test-5 replaced not duped).](#30ee-belief-profile-full-run-complete-both-stages-0-errors-8787-profiles-tagged-atopic-dermatitis-308-positionshcp-matches-nsclc-baseline-351-gate-14-holds-at-scale-idempotency-held-test-5-replaced-not-duped)
- [30ef. REGRESSION on server restart: Guttman-Yassky shows "Unclassified" + WHOLE profile collapsed (no Why This Expert, no Signal Summary, no Belief Profile, no score block). This afternoon she rendered FULLY (§30dj/dk). Likely: dev server restarted on WRONG BRANCH (pre-fix code).](#30ef-regression-on-server-restart-guttman-yassky-shows-unclassified-whole-profile-collapsed-no-why-this-expert-no-signal-summary-no-belief-profile-no-score-block-this-afternoon-she-rendered-fully-30djdk-likely-dev-server-restarted-on-wrong-branch-pre-fix-code)
- [30eg. Guttman-Yassky IS in ranks_v3 (global rank 1 + US rank 1) but frontend says "Unclassified" = CONTRADICTION. Also she moved 2->1 since this afternoon = ranks table CHANGED. Not stale build (branch confirmed). Investigate what recomputed ranks + why read path misses her.](#30eg-guttman-yassky-is-in-ranks_v3-global-rank-1-us-rank-1-but-frontend-says-unclassified-contradiction-also-she-moved-2-1-since-this-afternoon-ranks-table-changed-not-stale-build-branch-confirmed-investigate-what-recomputed-ranks-why-read-path-misses-her)
- [30eh. Ranks are July-8 stable (computed_at 2026-07-08 18:16:34) - NO recompute tonight; Claude misremembered her as "rank 2 this afternoon" (she's been global+US rank 1 since the 8th). Hard-refresh did NOT fix. => running frontend not executing the score-block fix despite branch being correct.](#30eh-ranks-are-july-8-stable-computed_at-2026-07-08-181634---no-recompute-tonight-claude-misremembered-her-as-rank-2-this-afternoon-shes-been-globalus-rank-1-since-the-8th-hard-refresh-did-not-fix-running-frontend-not-executing-the-score-block-fix-despite-branch-being-correct)
- [30ei. RESOLVED: stale Vite dev-server process was serving old bundles. Full kill + `npm run dev` restart brought the score-block fix back into running code -> Guttman-Yassky renders fully incl Belief Profile. Data was correct throughout.](#30ei-resolved-stale-vite-dev-server-process-was-serving-old-bundles-full-kill-npm-run-dev-restart-brought-the-score-block-fix-back-into-running-code---guttman-yassky-renders-fully-incl-belief-profile-data-was-correct-throughout)
- [30ej. Belief Profile FOUNDER GUT-CHECK PASSED (Guttman-Yassky reads legitimate). Deep Corpus, 10 papers/50 positions. Specific to HER real work (single-cell, tape-strip, CCL17/TARC, IL-13/JAK1). Advocacy-vs-caution split working. Advisor read still ideal for the definitive domain-truth nod.](#30ej-belief-profile-founder-gut-check-passed-guttman-yassky-reads-legitimate-deep-corpus-10-papers50-positions-specific-to-her-real-work-single-cell-tape-strip-ccl17tarc-il-13jak1-advocacy-vs-caution-split-working-advisor-read-still-ideal-for-the-definitive-domain-truth-nod)
- [30ek. CONCERN (Garrett): platform surfaces only 19 US Established AD HCPs. Diagnose kind-of-problem BEFORE fixing. Likely: nppes_practice_state bottleneck (US filter needs practice-state; only ~31% NPPES match) stacking on AD's 82%-intl skew - NOT a small roster.](#30ek-concern-garrett-platform-surfaces-only-19-us-established-ad-hcps-diagnose-kind-of-problem-before-fixing-likely-nppes_practice_state-bottleneck-us-filter-needs-practice-state-only-31-nppes-match-stacking-on-ads-82-intl-skew---not-a-small-roster)
- [30el. "19 US Established" was a FILTER/DISPLAY ARTIFACT - real US Established roster = 447. Practice-state gap real: 447 US-by-country but only 153 have nppes_practice_state (294 invisible to STATE-based territory filters). Dashboard now shows full roster (post Vite restart).](#30el-19-us-established-was-a-filterdisplay-artifact---real-us-established-roster-447-practice-state-gap-real-447-us-by-country-but-only-153-have-nppes_practice_state-294-invisible-to-state-based-territory-filters-dashboard-now-shows-full-roster-post-vite-restart)
- [30em. CORRECTION: the dashboard DOES render exactly 19 cards (Claude miscounted "24+"). So 19 is REAL + reproducible POST-restart, NOT a stale ghost. Hard contradiction: DB 447 US Established, feed renders 19. Find where 447->19 collapses. Likely a FEED LIMIT/PAGINATION (the 19 are the TOP-19 by rank) or the "Territory (US-intel)" filter.](#30em-correction-the-dashboard-does-render-exactly-19-cards-claude-miscounted-24-so-19-is-real-reproducible-post-restart-not-a-stale-ghost-hard-contradiction-db-447-us-established-feed-renders-19-find-where-447-19-collapses-likely-a-feed-limitpagination-the-19-are-the-top-19-by-rank-or-the-territory-us-intel-filter)
- [30en. DIAGNOSIS: the 447->19 collapse is a FEED LIMIT/PAGINATION cap, NOT a filter. State distribution scatters across ~29 states (CA 24/NY 20/TX 10...) summing to 145 - NO single state has 19. So 19 != a state count + != practice-state (145). The feed renders top-19-by-rank then stops = a limit.](#30en-diagnosis-the-447-19-collapse-is-a-feed-limitpagination-cap-not-a-filter-state-distribution-scatters-across-29-states-ca-24ny-20tx-10-summing-to-145---no-single-state-has-19-so-19-a-state-count-practice-state-145-the-feed-renders-top-19-by-rank-then-stops-a-limit)
- [30eo. REFRAME (Garrett caught it): feed shows Guttman-Yassky in #1 CARD position but she's US rank #2 - the true US #1 (Silverberg) is MISSING from the feed. So it's a FILTER DROPPING SPECIFIC HCPs, not just a count limit. The dropped #1 is the key.](#30eo-reframe-garrett-caught-it-feed-shows-guttman-yassky-in-1-card-position-but-shes-us-rank-2---the-true-us-1-silverberg-is-missing-from-the-feed-so-its-a-filter-dropping-specific-hcps-not-just-a-count-limit-the-dropped-1-is-the-key)
- [30ep. ROOT CAUSE FOUND (Code, empirical): TWO stacking bugs = 447->19. Practice-state was a RED HERRING (confirmed). Bug A: count RPC reads wrong table (v2 not v3) -> AD count=0 -> Load-More gated off -> feed frozen at page-1 (20). Bug B: industry filter substring "roche" eats "University of Rochester" (rank 18) -> 20-1=19.](#30ep-root-cause-found-code-empirical-two-stacking-bugs-447-19-practice-state-was-a-red-herring-confirmed-bug-a-count-rpc-reads-wrong-table-v2-not-v3---ad-count0---load-more-gated-off---feed-frozen-at-page-1-20-bug-b-industry-filter-substring-roche-eats-university-of-rochester-rank-18---20-119)
- [30eq. Both fixes AUDITED + APPROVED. Bug A = Established-count-only (Rising/Community count RPCs verified consistent - NOT affected). NSCLC safe (2885 v2==v3 identical). Bug B blast radius = only 1 false-pos (Rochester, 4 HCPs); other 72 real pharma. Apply both.](#30eq-both-fixes-audited-approved-bug-a-established-count-only-risingcommunity-count-rpcs-verified-consistent---not-affected-nsclc-safe-2885-v2v3-identical-bug-b-blast-radius-only-1-false-pos-rochester-4-hcps-other-72-real-pharma-apply-both)
- [30er. Bugs A+B fixed (Load More appeared, Rochester KOL back = +1) BUT unmasked a THIRD bug: "Load 20 More" added only 1 card (not 20), and Silverberg (#1) STILL missing. => the ROWS RPC only returns ~21 rows total, not 447. Count(447) and rows(~21) now disagree the OTHER way. A filter on the ROWS query cuts 447->~21, dropping Silverberg.](#30er-bugs-ab-fixed-load-more-appeared-rochester-kol-back-1-but-unmasked-a-third-bug-load-20-more-added-only-1-card-not-20-and-silverberg-1-still-missing-the-rows-rpc-only-returns-21-rows-total-not-447-count447-and-rows21-now-disagree-the-other-way-a-filter-on-the-rows-query-cuts-447-21-dropping-silverberg)
- [30es. Bug #3 ROOT CAUSE: loadMore (App.tsx:533) OMITS taId from its filters object -> getEstablished falls back to TA_ID_MAP['immunology'] = PARENT Immunology ta_id (0 Established rows) -> Load More fetches empty page. Rows RPC is INNOCENT (returns 447, Silverberg #1). Silverberg NOT dropped - browser is running a STALE BUNDLE.](#30es-bug-3-root-cause-loadmore-apptsx533-omits-taid-from-its-filters-object---getestablished-falls-back-to-ta_id_mapimmunology-parent-immunology-ta_id-0-established-rows---load-more-fetches-empty-page-rows-rpc-is-innocent-returns-447-silverberg-1-silverberg-not-dropped---browser-is-running-a-stale-bundle)
- [30et. All 3 feed fixes COMMITTED (0dcc0d1). Audit: taId omission was loadMore-ONLY; its filters object is SHARED across established/community/rising branches -> the one fix covers all 3 cohorts' pagination. Verify in browser after CLEAN restart (B+C ship in the bundle - stale bundle = why Silverberg looked missing).](#30et-all-3-feed-fixes-committed-0dcc0d1-audit-taid-omission-was-loadmore-only-its-filters-object-is-shared-across-establishedcommunityrising-branches---the-one-fix-covers-all-3-cohorts-pagination-verify-in-browser-after-clean-restart-bc-ship-in-the-bundle---stale-bundle-why-silverberg-looked-missing)
- [30eu. After all 3 fixes + restart: HCPs load + paginate, but Silverberg STILL not #1 in the rendered feed - though the rows RPC returns him rank 1 (Code proved directly §30es). Contradiction persists. Split: is he PRESENT-but-not-first (client-side sort bug) or ABSENT (a filter still dropping him)?](#30eu-after-all-3-fixes-restart-hcps-load-paginate-but-silverberg-still-not-1-in-the-rendered-feed---though-the-rows-rpc-returns-him-rank-1-code-proved-directly-30es-contradiction-persists-split-is-he-present-but-not-first-client-side-sort-bug-or-absent-a-filter-still-dropping-him)
- [30ev. CONFIRMED not stale bundle (clean restart + cache-disabled, Silverberg STILL absent). He's dropped by something REAL + specific between RPC-return (he's rank 1) and render. Trace his row end-to-end. Prime suspects: industry regex edge on "George Washington University", client-side dedup collision, or a null-field card-render guard.](#30ev-confirmed-not-stale-bundle-clean-restart-cache-disabled-silverberg-still-absent-hes-dropped-by-something-real-specific-between-rpc-return-hes-rank-1-and-render-trace-his-row-end-to-end-prime-suspects-industry-regex-edge-on-george-washington-university-client-side-dedup-collision-or-a-null-field-card-render-guard)
- [30ew. FOUND IT (Garrett, via the FILTERS panel not the feed): DC is MISSING/unselected in the US States filter. All 50 states lit, DC greyed. Silverberg is at George Washington University, practice_state="DC" -> filtered out because DC isn't in the selected-states set. That's why the #1 US KOL drops.](#30ew-found-it-garrett-via-the-filters-panel-not-the-feed-dc-is-missingunselected-in-the-us-states-filter-all-50-states-lit-dc-greyed-silverberg-is-at-george-washington-university-practice_statedc---filtered-out-because-dc-isnt-in-the-selected-states-set-thats-why-the-1-us-kol-drops)
- [30ex. TWO problems, second is structural: (1) DC omitted (3 AD HCPs incl Silverberg). (2) 302 of 447 US Established AD HCPs have NULL practice_state -> excluded whenever ANY state filter active = 68% of US roster invisible under territory filtering. Garrett: "AD needs to filter differently than NSCLC." CORRECT - this is a product-design fork.](#30ex-two-problems-second-is-structural-1-dc-omitted-3-ad-hcps-incl-silverberg-2-302-of-447-us-established-ad-hcps-have-null-practice_state---excluded-whenever-any-state-filter-active-68-of-us-roster-invisible-under-territory-filtering-garrett-ad-needs-to-filter-differently-than-nsclc-correct---this-is-a-product-design-fork)
- [30ey. ===== END-OF-DAY CLOSEOUT (2026-07-10 night) =====](#30ey-end-of-day-closeout-2026-07-10-night-)
- [30ez. AD RISING FRONTEND = larger than a repoint (grep-confirmed). Tier 1 now; archetype + Landscape + Home/Watchlists/Briefs are logged follow-ups.](#30ez-ad-rising-frontend-larger-than-a-repoint-grep-confirmed-tier-1-now-archetype-landscape-homewatchlistsbriefs-are-logged-follow-ups)

### from TA_BUILD_DEBT_ch2.md
- [30fa. AD RISING migration AUTHORED — get_rising_composite_filtered/_count, mirrors ESTABLISHED (not old-rising). Traced both bodies first.](#30fa-ad-rising-migration-authored-get_rising_composite_filtered_count-mirrors-established-not-old-rising-traced-both-bodies-first)
- [30fb. *** CAREER-YEAR COLUMN: use career_first_pub_year_v2, NOT plain. 76% corpus divergence — verified. ***](#30fb-career-year-column-use-career_first_pub_year_v2-not-plain-76-corpus-divergence-verified-)
- [30fc. SCORING LAYER CLEAN — rising ranks built on v2, no re-score. Established RANKS clean too (card DISPLAY bug only).](#30fc-scoring-layer-clean-rising-ranks-built-on-v2-no-re-score-established-ranks-clean-too-card-display-bug-only)
- [30fd. FRONTEND CONSUMER TRACE — entire rising read path speaks OLD 2x2 vocabulary. Confirms 4-tier blast radius (§30ez).](#30fd-frontend-consumer-trace-entire-rising-read-path-speaks-old-2x2-vocabulary-confirms-4-tier-blast-radius-30ez)
- [30fe. ARCHETYPE for AD = dropped by the advisor's own logic (not a feature loss). Decision logged; re-derivation deferred.](#30fe-archetype-for-ad-dropped-by-the-advisors-own-logic-not-a-feature-loss-decision-logged-re-derivation-deferred)
- [30ff. AD-ONLY FORK found + designed — NSCLC stays BYTE-IDENTICAL (architectural guarantee, not vigilance). Baseline captured.](#30ff-ad-only-fork-found-designed-nsclc-stays-byte-identical-architectural-guarantee-not-vigilance-baseline-captured)
- [30fg. *** GLOBAL-SCOPE RISING IS SERVED NOWHERE — pre-existing gap, and it blocks global-first AD. ***](#30fg-global-scope-rising-is-served-nowhere-pre-existing-gap-and-it-blocks-global-first-ad-)
- [30fh. DECISION (Garrett): AD is global-first — international researchers MUST be in the demo. Global = Tier-1 DoD.](#30fh-decision-garrett-ad-is-global-first-international-researchers-must-be-in-the-demo-global-tier-1-dod)
- [30fi. NSCLC back-migration DEFERRED — mentors live in the NSCLC DB, NSCLC is frozen. Split-brain is now DELIBERATE.](#30fi-nsclc-back-migration-deferred-mentors-live-in-the-nsclc-db-nsclc-is-frozen-split-brain-is-now-deliberate)
- [30fj. AD ESTABLISHED SHIPS US-DEFAULTED — global-first is NOT solved anywhere. No pattern to mirror.](#30fj-ad-established-ships-us-defaulted-global-first-is-not-solved-anywhere-no-pattern-to-mirror)
- [30fk. *** GLOBAL IS UNWIRED AT THE SQL LAYER — removing the short-circuit yields EMPTY, not global. RPC rewrite required. ***](#30fk-global-is-unwired-at-the-sql-layer-removing-the-short-circuit-yields-empty-not-global-rpc-rewrite-required-)
- [30fl. DECISION (Garrett): AD is heavily global -> respect it. Option 2 (fix the choke point once, both cohorts).](#30fl-decision-garrett-ad-is-heavily-global---respect-it-option-2-fix-the-choke-point-once-both-cohorts)
- [30fm. RPC-LAYER SPEC ISSUED (SQL only, no frontend). Two files authored; global proven in isolation before wiring.](#30fm-rpc-layer-spec-issued-sql-only-no-frontend-two-files-authored-global-proven-in-isolation-before-wiring)
- [30fn. *** RPC LAYER APPLIED + VERIFIED — global works, region/US byte-identical, parity holds. First verified-applied state. ***](#30fn-rpc-layer-applied-verified-global-works-regionus-byte-identical-parity-holds-first-verified-applied-state-)
- [30fo. FRONTEND FORK AUDIT (read-only) — 6 sites mapped, current line numbers. Two findings change the plan.](#30fo-frontend-fork-audit-read-only-6-sites-mapped-current-line-numbers-two-findings-change-the-plan)
- [30fp. STAGE 1 + STAGE 2 SHIPPED — AD Rising renders (Emergence/Network), committed + browser-verified. NSCLC frozen throughout.](#30fp-stage-1-stage-2-shipped-ad-rising-renders-emergencenetwork-committed-browser-verified-nsclc-frozen-throughout)
- [30fq. NEXT (morning): AD Rising NARRATIVES — §30fs enrichment repoint. Traced, NOT a drop-in. Two real changes required.](#30fq-next-morning-ad-rising-narratives-30fs-enrichment-repoint-traced-not-a-drop-in-two-real-changes-required)
- [30fr. AD RISING NARRATIVES shipped (99/100) + FEED INDUSTRY BADGE. Two commits. AD Rising now complete end-to-end.](#30fr-ad-rising-narratives-shipped-99100-feed-industry-badge-two-commits-ad-rising-now-complete-end-to-end)
- [30fs. SESSION FRICTION NOTE (process, not code). Tooling latency >> problem difficulty tonight.](#30fs-session-friction-note-process-not-code-tooling-latency-problem-difficulty-tonight)
- [30ft. COMMUNITY EXPLORER shipped on real data + cohort-scope refinement + FUTURE data-completeness audit.](#30ft-community-explorer-shipped-on-real-data-cohort-scope-refinement-future-data-completeness-audit)
- [30fu. TELESCOPE shipped for AD (collaboration network) + interaction upgrades for BOTH TAs. Terminal Code switch.](#30fu-telescope-shipped-for-ad-collaboration-network-interaction-upgrades-for-both-tas-terminal-code-switch)
- [30fv. INSTITUTIONS surface made AD-aware end-to-end (4th surface). 3 pieces + 2 slug bugs + 6th-site partner fix.](#30fv-institutions-surface-made-ad-aware-end-to-end-4th-surface-3-pieces-2-slug-bugs-6th-site-partner-fix)
- [30fw. MULTI-TA AUDIT complete → docs/MULTI_TA_AUDIT.md. Workstream is FOUNDATION-FIRST (both forks confirmed).](#30fw-multi-ta-audit-complete-docsmulti_ta_auditmd-workstream-is-foundation-first-both-forks-confirmed)
- [30fx. MULTI-TA Phase 1a (TAContext foundation) committed + the AMBIENT-vs-ENTITY boundary rule.](#30fx-multi-ta-phase-1a-tacontext-foundation-committed-the-ambient-vs-entity-boundary-rule)
- [30fy. MULTI-TA Phase 1b.1 (home tiles) committed + 3 durable patterns + the rising-table gap is now systemic.](#30fy-multi-ta-phase-1b1-home-tiles-committed-3-durable-patterns-the-rising-table-gap-is-now-systemic)
- [30fz. MULTI-TA Phase 1b.2 (Change 1) — feed AD-branch predicates re-sourced. Context-lag principle discovered.](#30fz-multi-ta-phase-1b2-change-1-feed-ad-branch-predicates-re-sourced-context-lag-principle-discovered)
- [30ga. *** MAJOR DATA BUG FOUND: NSCLC Established feed is 61% non-NSCLC (scorer cartesian product + incomplete v2→v3 migration). Change 2 BLOCKED & would MASK it. ***](#30ga-major-data-bug-found-nsclc-established-feed-is-61-non-nsclc-scorer-cartesian-product-incomplete-v2v3-migration-change-2-blocked-would-mask-it-)
- [30gb. ESTABLISHED-SCORER FIX — step 1 (NSCLC classification) validated + the dedup reversal + fragments deferred.](#30gb-established-scorer-fix-step-1-nsclc-classification-validated-the-dedup-reversal-fragments-deferred)
- [30gc. [FOLLOW-UP, small frontend] Display scores to ONE DECIMAL across all surfaces.](#30gc-follow-up-small-frontend-display-scores-to-one-decimal-across-all-surfaces)
- [30gd. *** ESTABLISHED-SCORER FIX LANDED CLEAN — NSCLC contamination ELIMINATED (61% → 0%). ***](#30gd-established-scorer-fix-landed-clean-nsclc-contamination-eliminated-61-0-)
- [30ge. DOWNSTREAM REGEN scoped + telescope repointed + TWO MORE contaminated surfaces found (getTACounts, getHCPDetail).](#30ge-downstream-regen-scoped-telescope-repointed-two-more-contaminated-surfaces-found-gettacounts-gethcpdetail)
- [30gf. Contamination propagation: getHCPDetail (user-visible) + getTACounts repointed; 1353 is dead; dead-path cleanup deferred.](#30gf-contamination-propagation-gethcpdetail-user-visible-gettacounts-repointed-1353-is-dead-dead-path-cleanup-deferred)
- [30gg. NIGHT SESSION CLOSE — decontamination propagation done; regeneration content still pending.](#30gg-night-session-close-decontamination-propagation-done-regeneration-content-still-pending)
- [30gh. DATA-COMPLETENESS AUDIT complete → docs/DATA_COMPLETENESS_AUDIT.md. The dread quantified: BOUNDED.](#30gh-data-completeness-audit-complete-docsdata_completeness_auditmd-the-dread-quantified-bounded)
- [30gi. [FORWARD-LOOKING / STRATEGIC] Scheduled re-ingest — after the desk is clean.](#30gi-forward-looking-strategic-scheduled-re-ingest-after-the-desk-is-clean)
- [30gj. CLEANLINESS SWEEP (day) — 3 of 4 data-completeness items closed; Hep fully parked; active-status honest.](#30gj-cleanliness-sweep-day-3-of-4-data-completeness-items-closed-hep-fully-parked-active-status-honest)
- [30gk. MULTI-TA SWITCHER — entitlement model READ SIDE (foundation). Design decisions locked.](#30gk-multi-ta-switcher-entitlement-model-read-side-foundation-design-decisions-locked)
- [30gl. *** SELF-SERVE INVITE-GATED SIGNUP — BUILT & VERIFIED END-TO-END. #1 launch blocker CLEARED. ***](#30gl-self-serve-invite-gated-signup-built-verified-end-to-end-1-launch-blocker-cleared-)

### from TA_BUILD_DEBT_ch3.md
- [31a. SESSION KICKOFF — PUBLIC MARKETING LANDING PAGE (besselanalytics.com root) + feature-def extraction. Anti-stale-memory discipline invoked.](#31a-session-kickoff-public-marketing-landing-page-besselanalyticscom-root-feature-def-extraction-anti-stale-memory-discipline-invoked)
- [31b. FEATURE DEFINITIONS EXTRACTED (ground truth) → CANONICAL FEATURE SURFACE captured + COPY written. 3 memory corrections; in-app stale strings logged as separate debt.](#31b-feature-definitions-extracted-ground-truth-canonical-feature-surface-captured-copy-written-3-memory-corrections-in-app-stale-strings-logged-as-separate-debt)
- [31c. COMMUNITY = market-the-layer / gate-the-drill-down. AI = trust-split (transparent scoring vs grounded synthesis) + one concentrated band.](#31c-community-market-the-layer-gate-the-drill-down-ai-trust-split-transparent-scoring-vs-grounded-synthesis-one-concentrated-band)
- [31d. COMMUNITY reframed → "Deep field" (astronomy). AI band DE-NAMED (no vendor). 2 live-draft tile overclaims flagged. Motion set + demo built.](#31d-community-reframed-deep-field-astronomy-ai-band-de-named-no-vendor-2-live-draft-tile-overclaims-flagged-motion-set-demo-built)
- [31e. INFRA REFERENCE — analytics = PostHog (so it stops being the thing to re-search). Deploy chain + Community restyle landed same day.](#31e-infra-reference-analytics-posthog-so-it-stops-being-the-thing-to-re-search-deploy-chain-community-restyle-landed-same-day)
- [31f. DYNAMISM / HABIT-LOOP STRATEGY + PostHog measurement plan (pre-mass-launch). Field Intelligence reframed.](#31f-dynamism-habit-loop-strategy-posthog-measurement-plan-pre-mass-launch-field-intelligence-reframed)
- [31g. WEEK PLAN LOCKED: reingest-first. Two foundational discoveries — reingest is UNPROVEN (warm path), Field Intelligence is a MOCK.](#31g-week-plan-locked-reingest-first-two-foundational-discoveries-reingest-is-unproven-warm-path-field-intelligence-is-a-mock)
- [31h. WARM-REINGEST TEST → became a DEDUP-RESIDUE CLEANUP + found a MERGER BUG. (NSCLC guinea-pig session.)](#31h-warm-reingest-test-became-a-dedup-residue-cleanup-found-a-merger-bug-nsclc-guinea-pig-session)
- [31i. DEDUP CLEANUP EXECUTED — merger bug fixed, 37 fragments merged, both NSCLC KOLs resolved. (continues §31h)](#31i-dedup-cleanup-executed-merger-bug-fixed-37-fragments-merged-both-nsclc-kols-resolved-continues-31h)
- [31j. REINGEST TEST BLOCKED — no current Step C on disk. Last run MAY 22 (.pyc), only source is ARCHIVED, a REWRITE SPEC exists.](#31j-reingest-test-blocked-no-current-step-c-on-disk-last-run-may-22-pyc-only-source-is-archived-a-rewrite-spec-exists)
- [31k. THE REAL BLOCKER, PINNED: Step C (built or specced) is CLEAN-BUILD only — no incremental/warm reingest path exists. Architectural fork.](#31k-the-real-blocker-pinned-step-c-built-or-specced-is-clean-build-only-no-incrementalwarm-reingest-path-exists-architectural-fork)
- [31l. DECISION: build reingestion via Option 2 / Path B. create_hcps_v2.py build commissioned + 3 known future gaps documented.](#31l-decision-build-reingestion-via-option-2-path-b-create_hcps_v2py-build-commissioned-3-known-future-gaps-documented)
- [31m. create_hcps_v2.py BUILT + first live runs → idempotency bug found (v1/v2 table mismatch) → rolled back clean.](#31m-create_hcps_v2py-built-first-live-runs-idempotency-bug-found-v1v2-table-mismatch-rolled-back-clean)
- [31n. ✅ IDEMPOTENCY PROVEN. Real bug was keyset-pagination straddle (not v1/v2 table — Claude's diag was wrong; log string fooled it).](#31n-idempotency-proven-real-bug-was-keyset-pagination-straddle-not-v1v2-table-claudes-diag-was-wrong-log-string-fooled-it)
- [31o. FINDING: identity_hash is NULL for 95% of corpus (268,853/282,427). Idempotency layer 2 is inert → backfill required.](#31o-finding-identity_hash-is-null-for-95-of-corpus-268853282427-idempotency-layer-2-is-inert-backfill-required)
- [31p. identity_hash backfill dry-run CLEAN + ingest audit: ingest is WINDOW-NATIVE (near-ready). Pipeline readiness mapped.](#31p-identity_hash-backfill-dry-run-clean-ingest-audit-ingest-is-window-native-near-ready-pipeline-readiness-mapped)
- [31q. ADVISOR INPUT (dynamism.docx) + Phase-1 diff spec commissioned. Backfill running (transient conn errors = self-healing).](#31q-advisor-input-dynamismdocx-phase-1-diff-spec-commissioned-backfill-running-transient-conn-errors-self-healing)
- [31r. ✅ identity_hash backfill COMPLETE (228,598 written) + diff engine done (FK dropped). Ready for the first real cycle.](#31r-identity_hash-backfill-complete-228598-written-diff-engine-done-fk-dropped-ready-for-the-first-real-cycle)
- [31s. First real cycle STARTED (33 pubs ingested) → hit the real edge: incremental-reingest PIPELINE is undesigned (ROADMAP confirms).](#31s-first-real-cycle-started-33-pubs-ingested-hit-the-real-edge-incremental-reingest-pipeline-is-undesigned-roadmap-confirms)
- [31t. ✅ GATE-C PASSED — new-fragment-of-existing-HCP routes via identity_hash (the Riely/Hirsch mechanism, now provably prevented).](#31t-gate-c-passed-new-fragment-of-existing-hcp-routes-via-identity_hash-the-rielyhirsch-mechanism-now-provably-prevented)
- [31u. GATE-B caught a real clobber (933 authors) → root-caused to pre-existing author_pub_flat/inventory DRIFT → GREATEST fix.](#31u-gate-b-caught-a-real-clobber-933-authors-root-caused-to-pre-existing-author_pub_flatinventory-drift-greatest-fix)
- [31v. Back-half walk: Step C 428 new HCPs (3 real fragment-catches) → discovered back-half needs scoping. Tooling built. Paused at ta_tagging validation.](#31v-back-half-walk-step-c-428-new-hcps-3-real-fragment-catches-discovered-back-half-needs-scoping-tooling-built-paused-at-ta_tagging-validation)


---
---

# ===== source: TA_BUILD_DEBT.md =====
