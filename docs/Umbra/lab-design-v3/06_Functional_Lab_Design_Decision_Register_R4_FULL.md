...
Source text characters: 7616
Rendered characters: 9452
-->
...
# Functional Lab Design Decision Register — Revision 4

Revision: 4
Design version: functional-lab-design.v4
Work ID: 3ec81bc4b1f347eebe16158e94e42a0c
Created: 2026-07-28T03:58:36.751096Z
Original Revision 3 artifact: `functional-lab-design-r3-artifact-65f56e6108c4d94d03e3d7c3a9d37d18`
...
|---|---|---|
| First topology | LOCAL_POSTGRES_PLUS_MANAGED_WORKTREE | ACCEPTED |
| Host | Umbra K11, 32 GB | ACCEPTED_FOR_FIRST_PROOF |
| Bootstrap | COMPLETE_SCHEMA_DUMP_PLUS_LIVE_SQL_MANIFEST | BLOCKED_PENDING_COMPLETE_ARTIFACT |
| Candidate disposition | INCOMPLETE | STATIC_INSPECTION_COMPLETE |
| Breast surface | 24 scripts | AUTHORITATIVE_REPORTED_INVENTORY |
| Command admission | LAB_COMMAND_ADMISSION_MANIFEST | REQUIRED |
| v2 enforcement | REQUIRED_PRE_LAB_PLATFORM_CONTROL | DESIGNED_PENDING_IMPLEMENTATION_AUTHORIZATION |
| Container Lab | FOLLOW_ON_PLATFORM_MILESTONE | parity: ACCEPTED_BREAST_FUNCTIONAL_BUILD |
| Breast operating model | CONVERSATIONAL_ORGANIZATIONAL_EXECUTION | AFTER_FOUNDATION_ACCEPTANCE |
| dedup merge | EXCLUDED_FROM_BREAST_REPLAY | ACCEPTED |
| Provider spend | ZERO_UNLESS_SEPARATELY_AUTHORIZED | ACCEPTED |

Unresolved: exact source HEAD, passing schema artifact, PostgreSQL version,
resource caps, retention, later corpus/API budgets, entitlement, Rising model,
cross-TA rehearsal, production replay/activation, and future dedup policy.
...
**Original artifact id:** functional-lab-design-r3-artifact-65f56e6108c4d94d03e3d7c3a9d37d18
