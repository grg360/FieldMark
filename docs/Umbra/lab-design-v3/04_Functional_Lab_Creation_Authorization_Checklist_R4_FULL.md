...
Source text characters: 7526
Rendered characters: 9362
-->
...
# Functional Lab Creation Authorization Checklist — Revision 4

Revision: 4
Design version: functional-lab-design.v4
Work ID: 3ec81bc4b1f347eebe16158e94e42a0c
Created: 2026-07-28T03:58:36.751096Z
Original Revision 3 artifact: `functional-lab-design-r3-artifact-a28840a30000c11b8033d96d5a3d46ed`
...
Complete schema admitted: `false`.
Lab Foundation authorization available now: `false`.

## LAB_FOUNDATION_AND_V2_PATCH_AUTHORIZED

Requires exact source commit and clean state; managed-worktree and integration
owner; K11 and existing 32 GB memory; PostgreSQL version/name; passing schema
artifact ID/hash/disposition; commit-specific `sql/README.md`; empty-database
replay plan; extensions, roles/grants and reload requirements; authoritative
24-script inventory; explicit command manifest; authorized code-level v2
patch; v2 pre/post validation; Tier 1 fixture scope; egress disabled; ports;
storage/CPU/runtime caps; provider budget $0; no production credentials or
connection; dedup merge prohibited; reset/teardown and evidence retention.

`DESIGN_APPROVED` permits review only.

`LAB_FOUNDATION_AND_V2_PATCH_AUTHORIZED` may permit Foundation, Tier 1 fixtures
and the bounded v2 safeguard.

`BREAST_CORPUS_RUN_AUTHORIZED` is a later decision. The second never implies
the third.
...
**Original artifact id:** functional-lab-design-r3-artifact-a28840a30000c11b8033d96d5a3d46ed
