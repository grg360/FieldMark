...
Source text characters: 7461
Rendered characters: 9297
-->
...
# Bounded v2 Enforcement Development Handoff — Revision 4

Revision: 4
Design version: functional-lab-design.v4
Work ID: 3ec81bc4b1f347eebe16158e94e42a0c
Created: 2026-07-28T03:58:36.751096Z
Original Revision 3 artifact: `functional-lab-design-r3-artifact-0bedba61f37fa3473a22c0ad9bb2dd59`
...
Implement the smallest shared code-level safeguard that makes v2 the governed
Lab default across the admitted subset of the authoritative 24-script surface.

## Required behavior

- Governed Lab mode defaults to v2.
- Explicit v1, missing or unknown version fails before work.
- Required unexpectedly empty v2 input fails preflight.
- Explicit `--target-version v2` remains visible in admitted commands.
- Expected v2 output, TA and provenance verify after execution.
- Exit zero alone is insufficient; silent zero output is `FAILED_VALIDATION`.
- Target version and checks enter the run manifest/evidence.
- Tests cover default, explicit v2, explicit v1, missing input and zero output.

The development agent must inspect current source and reuse a real shared
argument/configuration mechanism when available. Do not invent a framework if
the scripts do not share one. This handoff designs the patch; it does not
...
**Original artifact id:** functional-lab-design-r3-artifact-0bedba61f37fa3473a22c0ad9bb2dd59
