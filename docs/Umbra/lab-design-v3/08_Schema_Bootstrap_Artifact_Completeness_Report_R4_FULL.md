...
Source text characters: 8091
Rendered characters: 10930
-->
...
# Schema Bootstrap Artifact Completeness Report — Revision 4
...
- Artifact: `local-artifact-2f62a90b5a7567fff8a3df6ad500420f`
- SHA-256: `2f62a90b5a7567fff8a3df6ad500420f755e515773796d3f8f60ba8b9d1056ee`
- Bytes: `414937`
- Lines: `11548`
...
```json
{
  ...
  "foreign_key": 132,
  "function": 46,
  "gen_random_uuid_use": 2,
  "grant": 696,
  "owner_statement": 231,
  "pgcrypto_extension": 0,
  "policy": 102,
  "primary_key": 134,
  "procedure": 0,
  "rls_enablement": 152,
...
- No CREATE EXTENSION pgcrypto statement or other self-contained source for gen_random_uuid() is established by the artifact.
- Static inspection does not prove that the dump executes cleanly.
- Empty-database replay remains a mandatory Wave 1 gate.

Result: the registered snapshot remains valid static structural evidence but
is `SUPERSEDED_FOR_LAB_BOOTSTRAP`. No complete candidate was found in the
approved registered/intake scope, so status is
`AWAITING_COMPLETE_SCHEMA_ARTIFACT`.
...
**Candidate artifact id:** local-artifact-2f62a90b5a7567fff8a3df6ad500420f

**Completeness disposition:** INCOMPLETE

### Data row scan

**Copy from stdin statements:** 0

**Result:** PASS

**Top level insert statements:** 0

**Extension source complete:** False

### Inspected candidate artifact ids
...
**Gen random uuid use:** 2

**Grant:** 696

**Owner statement:** 231

**Pgcrypto extension:** 0
...
**Required structure present:** True
...
**Postgres connection uris:** 0

**Result:** PASS

**Supabase connection uris:** 0
