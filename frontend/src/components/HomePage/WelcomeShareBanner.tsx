...
import { COLOR, FONT, RADIUS } from "../../lib/designTokens";
...
export default function WelcomeShareBanner() {
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ fontSize: 16, fontWeight: 600, color: COLOR.ink1 }}>
      ...
      <p style={{ fontSize: 13, color: COLOR.ink3, lineHeight: 1.5, margin: "0 0 14px 0" }}>
