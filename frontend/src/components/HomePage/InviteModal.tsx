...
export default function InviteModal({ userId, onClose }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        {success ? (
          <p style={{ fontSize: 15, color: "#E8E6DF", margin: 0, lineHeight: 1.5 }}>
          ...
          <>
            ...
            <p style={{ fontSize: 13, color: "#9B9892", margin: "0 0 20px 0", lineHeight: 1.5 }}>
            ...
            <p style={{ fontSize: 11, color: "#6B6A65", margin: "0 0 16px 0", lineHeight: 1.4 }}>
